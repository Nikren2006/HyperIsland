...
public class b extends g {
    ...
    public int q(com.airbnb.lottie.value.a aVar, float f2) {
        ...
        return (cVar == null || (num = (Integer) cVar.getValueInternal(aVar.f1398g, aVar.f1399h.floatValue(), (Integer) aVar.f1393b, (Integer) aVar.f1394c, f2, e(), f())) == null) ? AbstractC0722b.c(AbstractC0727g.b(f2, 0.0f, 1.0f), ((Integer) aVar.f1393b).intValue(), ((Integer) aVar.f1394c).intValue()) : num.intValue();
    }

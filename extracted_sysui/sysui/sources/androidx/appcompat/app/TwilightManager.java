...
class TwilightManager {
    ...
    private Location getLastKnownLocation() {
        ...
        Location lastKnownLocationForProvider2 = PermissionChecker.checkSelfPermission(this.mContext, "android.permission.ACCESS_FINE_LOCATION") == 0 ? getLastKnownLocationForProvider(QSFlipUtils.TILE_TYPE_GPS) : null;
    ...
    private void updateState(@NonNull Location location) {
        ...
        twilightCalculator.calculateTwilight(jCurrentTimeMillis - Constant.CACHE_EXPIRED_DURATION, location.getLatitude(), location.getLongitude());

...
class TwilightCalculator {
    ...
    private static final float f1129C1 = 0.0334196f;
    ...
    private static final float f1130J0 = 9.0E-4f;
    ...
    public void calculateTwilight(long j2, double d2, double d3) {
        ...
        double dRound = ((double) (Math.round(((double) (r3 - f1130J0)) - r7) + f1130J0)) + ((-d3) / 360.0d) + (Math.sin(d4) * 0.0053d) + (Math.sin(2.0d * dSin) * (-0.0069d));

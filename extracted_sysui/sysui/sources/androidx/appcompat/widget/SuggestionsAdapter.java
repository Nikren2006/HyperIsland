...
class SuggestionsAdapter extends ResourceCursorAdapter implements View.OnClickListener {
    ...
    public Cursor getSearchManagerSuggestions(SearchableInfo searchableInfo, String str, int i2) {
        ...
        Uri.Builder builderFragment = new Uri.Builder().scheme(Const.Param.CONTENT).authority(suggestAuthority).query("").fragment("");
        ...
        if (i2 > 0) {
            builderFragment.appendQueryParameter(Constant.QueryParameter.LIMIT, String.valueOf(i2));
        }

...
public class Toolbar extends ViewGroup implements MenuHost {
    ...
    */
    ...
    public void updateBackInvokedCallbackState() {
        ...
        boolean z2 = hasExpandedActionView() && onBackInvokedDispatcherFindOnBackInvokedDispatcher != null && ViewCompat.isAttachedToWindow(this) && this.mBackInvokedCallbackEnabled;
        if (z2 && this.mBackInvokedDispatcher == null) {
            if (this.mBackInvokedCallback == null) {
                this.mBackInvokedCallback = Api33Impl.newOnBackInvokedCallback(new Runnable() { // from class: androidx.appcompat.widget.a
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f1137a.collapseActionView();
                    }
                });
            }

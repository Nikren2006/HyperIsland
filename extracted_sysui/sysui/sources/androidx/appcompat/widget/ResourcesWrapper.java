...
class ResourcesWrapper extends Resources {
    ...
    public Drawable getDrawableForDensity(int i2, int i3) {
        return ResourcesCompat.getDrawableForDensity(this.mResources, i2, i3, null);
    }
    ...
    public Drawable getDrawable(int i2, Resources.Theme theme) {
        return ResourcesCompat.getDrawable(this.mResources, i2, theme);
    }

    @Override // android.content.res.Resources
    @RequiresApi(21)
    public Drawable getDrawableForDensity(int i2, int i3, Resources.Theme theme) {
        return ResourcesCompat.getDrawableForDensity(this.mResources, i2, i3, theme);
    }

...
class AppCompatCheckedTextViewHelper {
    ...
    public void loadFromAttributes(@Nullable AttributeSet attributeSet, int i2) {
        ...
        try {
            ...
            if (!tintTypedArrayObtainStyledAttributes.hasValue(i4) || (resourceId2 = tintTypedArrayObtainStyledAttributes.getResourceId(i4, 0)) == 0) {
                i3 = R.styleable.CheckedTextView_android_checkMark;

...
class TooltipCompatHandler implements View.OnLongClickListener, View.OnHoverListener, View.OnAttachStateChangeListener {
    ...
    private final Runnable mShowRunnable = new Runnable() { // from class: androidx.appcompat.widget.d
        @Override // java.lang.Runnable
        public final void run() {
            this.f1140a.lambda$new$0();
        }
    };
    private final Runnable mHideRunnable = new Runnable() { // from class: androidx.appcompat.widget.e
        @Override // java.lang.Runnable
        public final void run() {
            this.f1141a.hide();
        }

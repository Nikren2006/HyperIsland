...
class MediaRoute2Provider extends MediaRouteProvider {
    ...
    public class GroupRouteController extends MediaRouteProvider.DynamicGroupRouteController {
        ...
        private final Runnable mClearOptimisticVolumeRunnable = new Runnable() { // from class: androidx.mediarouter.media.a
            @Override // java.lang.Runnable
            public final void run() {
                this.f1263a.lambda$new$0();
            }
        };
        ...
        public class ReceiveHandler extends Handler {
            ...
            public void handleMessage(Message message) {
                ...
                MediaRouter.ControlRequestCallback controlRequestCallback = GroupRouteController.this.mPendingCallbacks.get(i3);
                if (controlRequestCallback == null) {
                    Log.w(MediaRoute2Provider.TAG, "Pending callback not found for control request.");
                    return;
                }
                GroupRouteController.this.mPendingCallbacks.remove(i3);
                if (i2 == 3) {
                    ...
                    controlRequestCallback.onError(bundlePeekData == null ? null : bundlePeekData.getString(MediaRouteProviderProtocol.SERVICE_DATA_ERROR), (Bundle) obj);
                }
            }
        }
        ...
        public boolean onControlRequest(@NonNull Intent intent, @Nullable MediaRouter.ControlRequestCallback controlRequestCallback) {
            ...
            if (routingController != null && !routingController.isReleased() && this.mServiceMessenger != null) {
                ...
                try {
                    ...
                    Log.e(MediaRoute2Provider.TAG, "Could not send control request to service.", e2);
                }
            }
            return false;
        }
        ...
        public void onUpdateVolume(int i2) {
            ...
            int iMax = Math.max(0, Math.min(volume + i2, this.mRoutingController.getVolumeMax()));
        ...
        public void setMemberRouteVolume(@NonNull String str, int i2) {
            MediaRouter2.RoutingController routingController = this.mRoutingController;
            if (routingController == null || routingController.isReleased() || this.mServiceMessenger == null) {
                return;
            }
        ...
        public void updateMemberRouteVolume(@NonNull String str, int i2) {
            MediaRouter2.RoutingController routingController = this.mRoutingController;
            if (routingController == null || routingController.isReleased() || this.mServiceMessenger == null) {
                return;
            }
    ...
    public class MemberRouteController extends MediaRouteProvider.RouteController {
        ...
        public void onSetVolume(int i2) {
            ...
            groupRouteController.setMemberRouteVolume(str, i2);
        }
        ...
        public void onUpdateVolume(int i2) {
            ...
            groupRouteController.updateMemberRouteVolume(str, i2);
        }
    }
    ...
    public MediaRoute2Provider(@NonNull Context context, @NonNull Callback callback) {
        ...
        this.mHandlerExecutor = new androidx.emoji2.text.a(handler);
    }

    @Nullable
    public static Messenger getMessengerFromRoutingController(@Nullable MediaRouter2.RoutingController routingController) {
        Bundle controlHints;
    ...
    private MediaRouteDiscoveryRequest updateDiscoveryRequest(@Nullable MediaRouteDiscoveryRequest mediaRouteDiscoveryRequest, boolean z2) {
    ...
    public void refreshRoutes() {
        ...
        for (MediaRoute2Info mediaRoute2Info2 : this.mRoutes) {
            ...
            if (extras == null || extras.getString("androidx.mediarouter.media.KEY_ORIGINAL_ROUTE_ID") == null) {
                Log.w(TAG, "Cannot find the original route Id. route=" + mediaRoute2Info2);
            } else {

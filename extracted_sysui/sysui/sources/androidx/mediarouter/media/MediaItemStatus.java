...
public final class MediaItemStatus {
    ...
    public static final class Builder {
        ...
        public Builder setContentDuration(long j2) {
            this.mBundle.putLong(MediaItemStatus.KEY_CONTENT_DURATION, j2);
            return this;
        }

        @NonNull
        public Builder setContentPosition(long j2) {
            this.mBundle.putLong(MediaItemStatus.KEY_CONTENT_POSITION, j2);
            return this;
        }
        ...
        public Builder setExtras(@Nullable Bundle bundle) {
            if (bundle == null) {
                this.mBundle.putBundle(MediaItemStatus.KEY_EXTRAS, null);
            } else {
                this.mBundle.putBundle(MediaItemStatus.KEY_EXTRAS, new Bundle(bundle));
            }
            return this;
        }
        ...
        public Builder setPlaybackState(int i2) {
            this.mBundle.putInt(MediaItemStatus.KEY_PLAYBACK_STATE, i2);
            return this;
        }

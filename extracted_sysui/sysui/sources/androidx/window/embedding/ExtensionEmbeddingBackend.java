...
public final class ExtensionEmbeddingBackend implements EmbeddingBackend {
    ...
    public static final class Companion {
        ...
        private final EmbeddingInterfaceCompat initAndVerifyEmbeddingExtension() {
            ...
            try {
                ...
                Log.d(ExtensionEmbeddingBackend.TAG, n.o("Failed to load embedding extension: ", th));
            }
    ...
    public static final class SplitListenerWrapper {
        ...
        public static final void m53accept$lambda1(SplitListenerWrapper this$0, List splitsWithActivity) {
            n.g(this$0, "this$0");
            n.g(splitsWithActivity, "$splitsWithActivity");
        ...
        public final void accept(List<SplitInfo> splitInfoList) {
            ...
            if (n.c(arrayList, this.lastValue)) {
                return;
            }
            ...
            this.executor.execute(new Runnable() { // from class: androidx.window.embedding.f
                ...
                public final void run() {
                    ExtensionEmbeddingBackend.SplitListenerWrapper.m53accept$lambda1(this.f1295a, arrayList);
                }
            });
        }
    ...
    public void registerSplitListenerForActivity(Activity activity, Executor executor, Consumer<List<SplitInfo>> callback) {
        ...
        try {
            ...
            if (this.splitInfoEmbeddingCallback.getLastInfo() != null) {
                ...
                splitListenerWrapper.accept(m.h());
            }
            s sVar = s.f314a;
        } finally {
            reentrantLock.unlock();
    ...
    public void unregisterSplitListenerForActivity(Consumer<List<SplitInfo>> consumer) {
        ...
        try {
            ...
            while (true) {
                ...
                if (n.c(next.getCallback(), consumer)) {

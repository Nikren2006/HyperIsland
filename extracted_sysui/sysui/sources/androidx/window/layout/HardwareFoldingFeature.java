...
public final class HardwareFoldingFeature implements FoldingFeature {
    ...
    public HardwareFoldingFeature(Bounds featureBounds, Type type, FoldingFeature.State state) {
        n.g(featureBounds, "featureBounds");
        n.g(type, "type");
        n.g(state, "state");
    ...
    public boolean equals(Object obj) {
        ...
        if (!n.c(HardwareFoldingFeature.class, obj == null ? null : obj.getClass())) {
            return false;
        }
        if (obj == null) {
        ...
        return n.c(this.featureBounds, hardwareFoldingFeature.featureBounds) && n.c(this.type, hardwareFoldingFeature.type) && n.c(getState(), hardwareFoldingFeature.getState());
    }
    ...
    public boolean isSeparating() {
        ...
        if (n.c(type, companion.getHINGE())) {
            return true;
        }
        return n.c(this.type, companion.getFOLD()) && n.c(getState(), FoldingFeature.State.HALF_OPENED);
    }

...
final class OriginalScrollEventAdapter extends RecyclerView.OnScrollListener {
    ...
    @NonNull
    private final OriginalViewPager2 mViewPager;
    ...
    public OriginalScrollEventAdapter(@NonNull OriginalViewPager2 originalViewPager2) {
    ...
    private void dispatchScrolled(int i2, float f2, int i3) {
        OriginalViewPager2.OnPageChangeCallback onPageChangeCallback = this.mCallback;
    ...
    private void updateScrollEventValues() {
        ...
        if (i2 >= 0) {
            ...
            if (!new OriginalAnimateLayoutChangeDetector(this.mLayoutManager).mayHaveInterferingAnimations()) {
    ...
    */
    public void onScrolled(@androidx.annotation.NonNull androidx.recyclerview.widget.RecyclerView r4, int r5, int r6) {
        ...
        L16:
            r5 = r2
        L17:
            androidx.viewpager2.widget.OriginalViewPager2 r6 = r3.mViewPager
            boolean r6 = r6.isRtl()
            if (r5 != r6) goto L29
        L1f:
            androidx.viewpager2.widget.OriginalScrollEventAdapter$ScrollEventValues r5 = r3.mScrollValues
            int r6 = r5.mOffsetPx
            if (r6 == 0) goto L29
            int r5 = r5.mPosition
            int r5 = r5 + r4
        ...
        L6b:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.viewpager2.widget.OriginalScrollEventAdapter.onScrolled(androidx.recyclerview.widget.RecyclerView, int, int):void");
    }

    public void setOnPageChangeCallback(OriginalViewPager2.OnPageChangeCallback onPageChangeCallback) {

...
final class OriginalAnimateLayoutChangeDetector {
    ...
    public OriginalAnimateLayoutChangeDetector(@NonNull LinearLayoutManager linearLayoutManager) {
    ...
    private boolean arePagesLaidOutContiguously() {
        ...
        Arrays.sort(iArr, new Comparator<int[]>() { // from class: androidx.viewpager2.widget.OriginalAnimateLayoutChangeDetector.1

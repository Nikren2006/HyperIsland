...
public final class SavedStateHandleSupport {
    ...
    public static final SavedStateHandlesProvider getSavedStateHandlesProvider(SavedStateRegistryOwner savedStateRegistryOwner) {
        n.g(savedStateRegistryOwner, "<this>");
    ...
    public static final SavedStateHandlesVM getSavedStateHandlesVM(ViewModelStoreOwner viewModelStoreOwner) {
        ...
        initializerViewModelFactoryBuilder.addInitializer(z.b(SavedStateHandlesVM.class), SavedStateHandleSupport$savedStateHandlesVM$1$1.INSTANCE);

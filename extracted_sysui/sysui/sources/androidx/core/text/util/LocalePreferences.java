...
public final class LocalePreferences {
    ...
    private static String getBaseHourCycle(Locale locale) {
        return android.text.format.DateFormat.getBestDateTimePattern(locale, "jm").contains(ai.f2848b) ? HourCycle.H23 : HourCycle.H12;
    }
    ...
    public static String getCalendarType(Locale locale, boolean z2) {
    ...
    public static String getFirstDayOfWeek(Locale locale, boolean z2) {
    ...
    public static String getHourCycle(Locale locale, boolean z2) {
    ...
    public static String getTemperatureUnit(Locale locale, boolean z2) {

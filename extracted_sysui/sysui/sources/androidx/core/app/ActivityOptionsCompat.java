...
public class ActivityOptionsCompat {
    ...
    public static class ActivityOptionsCompatImpl extends ActivityOptionsCompat {
        ...
        @Override // androidx.core.app.ActivityOptionsCompat
        public ActivityOptionsCompat setLaunchDisplayId(int i2) {
        ...
        public ActivityOptionsCompat setPendingIntentBackgroundActivityStartMode(int i2) {
        ...
        public ActivityOptionsCompat setShareIdentityEnabled(boolean z2) {
            return new ActivityOptionsCompatImpl(this.mActivityOptions.setShareIdentityEnabled(z2));
        }

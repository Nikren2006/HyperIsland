...
class TypefaceCompatBaseImpl {
    ...
    private static <T> T findBestFont(T[] tArr, int i2, StyleExtractor<T> styleExtractor) {
        return (T) findBestFont(tArr, (i2 & 1) == 0 ? SearchActionModeView.ANIMATION_DURATION : TypedValues.TransitionType.TYPE_DURATION, (i2 & 2) != 0, styleExtractor);
    }
    ...
    public Typeface createFromFontFamilyFilesResourceEntry(Context context, FontResourcesParserCompat.FontFamilyFilesResourceEntry fontFamilyFilesResourceEntry, Resources resources, int i2, boolean z2) {

...
public final class ColorUtils {
    ...
    public static void LABToXYZ(@FloatRange(from = 0.0d, to = XYZ_WHITE_REFERENCE_Y) double d2, @FloatRange(from = -128.0d, to = 127.0d) double d3, @FloatRange(from = -128.0d, to = 127.0d) double d4, double[] dArr) {
    ...
    @ColorInt
    public static int M3HCTToColor(@FloatRange(from = 0.0d, to = 360.0d, toInclusive = false) float f2, @FloatRange(from = 0.0d, to = DurationMotion.DURATION_FOREVER, toInclusive = false) float f3, @FloatRange(from = 0.0d, to = XYZ_WHITE_REFERENCE_Y) float f4) {
        return CamColor.toColor(f2, f3, f4);
    }

    public static void RGBToHSL(@IntRange(from = 0, to = ScatterMapKt.Sentinel) int i2, @IntRange(from = 0, to = ScatterMapKt.Sentinel) int i3, @IntRange(from = 0, to = ScatterMapKt.Sentinel) int i4, float[] fArr) {
        float f2;
        float fAbs;
        float f3 = i2 / 255.0f;
        float f4 = i3 / 255.0f;
    ...
    public static void RGBToLAB(@IntRange(from = 0, to = ScatterMapKt.Sentinel) int i2, @IntRange(from = 0, to = ScatterMapKt.Sentinel) int i3, @IntRange(from = 0, to = ScatterMapKt.Sentinel) int i4, double[] dArr) {
        RGBToXYZ(i2, i3, i4, dArr);
        XYZToLAB(dArr[0], dArr[1], dArr[2], dArr);
    }

    public static void RGBToXYZ(@IntRange(from = 0, to = ScatterMapKt.Sentinel) int i2, @IntRange(from = 0, to = ScatterMapKt.Sentinel) int i3, @IntRange(from = 0, to = ScatterMapKt.Sentinel) int i4, double[] dArr) {
        if (dArr.length != 3) {
    ...
    public static void XYZToLAB(@FloatRange(from = 0.0d, to = XYZ_WHITE_REFERENCE_X) double d2, @FloatRange(from = 0.0d, to = XYZ_WHITE_REFERENCE_Y) double d3, @FloatRange(from = 0.0d, to = XYZ_WHITE_REFERENCE_Z) double d4, double[] dArr) {
        if (dArr.length != 3) {
    ...
    public static void blendHSL(float[] fArr, float[] fArr2, @FloatRange(from = 0.0d, to = 1.0d) float f2, float[] fArr3) {
        if (fArr3.length != 3) {
    ...
    public static void blendLAB(double[] dArr, double[] dArr2, @FloatRange(from = 0.0d, to = 1.0d) double d2, double[] dArr3) {
        if (dArr3.length != 3) {
    ...
    public static void colorToHSL(@ColorInt int i2, float[] fArr) {
        RGBToHSL(Color.red(i2), Color.green(i2), Color.blue(i2), fArr);
    }

    public static void colorToLAB(@ColorInt int i2, double[] dArr) {
        RGBToLAB(Color.red(i2), Color.green(i2), Color.blue(i2), dArr);
    }

    public static void colorToM3HCT(@ColorInt int i2, @Size(3) float[] fArr) {
        CamColor.getM3HCTfromColor(i2, fArr);
    }

    public static void colorToXYZ(@ColorInt int i2, double[] dArr) {
    ...
    @ColorInt
    public static int setAlphaComponent(@ColorInt int i2, @IntRange(from = 0, to = ScatterMapKt.Sentinel) int i3) {
        if (i3 < 0 || i3 > 255) {

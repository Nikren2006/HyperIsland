...
public final class ComplexColorCompat {
    ...
    private static ComplexColorCompat createFromXml(Resources resources, @ColorRes int i2, Resources.Theme theme) throws XmlPullParserException, IOException {
        int next;
    ...
    public static ComplexColorCompat inflate(Resources resources, @ColorRes int i2, Resources.Theme theme) {
        try {

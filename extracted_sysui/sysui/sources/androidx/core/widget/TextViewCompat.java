...
public final class TextViewCompat {
    ...
    public static class Api34Impl {
        ...
        public static void setLineHeight(TextView textView, int i2, @FloatRange(from = 0.0d) float f2) {
    ...
    public static void setFirstBaselineToTopHeight(TextView textView, @IntRange(from = 0) @Px int i2) {
        Preconditions.checkArgumentNonnegative(i2);
        Api28Impl.setFirstBaselineToTopHeight(textView, i2);
    }

    public static void setLastBaselineToBottomHeight(TextView textView, @IntRange(from = 0) @Px int i2) {
        Preconditions.checkArgumentNonnegative(i2);
    ...
    public static void setLineHeight(TextView textView, @IntRange(from = 0) @Px int i2) {
        Preconditions.checkArgumentNonnegative(i2);
    ...
    @ReplaceWith(expression = "textView.setCompoundDrawablesRelativeWithIntrinsicBounds(start, top, end, bottom)")
    @Deprecated
    public static void setCompoundDrawablesRelativeWithIntrinsicBounds(TextView textView, @DrawableRes int i2, @DrawableRes int i3, @DrawableRes int i4, @DrawableRes int i5) {

...
public class NestedScrollView extends FrameLayout implements NestedScrollingParent3, NestedScrollingChild3, ScrollingView {
    ...
    */
    ...
    private float getSplineFlingDistance(int i2) {
        double dLog = Math.log((Math.abs(i2) * 0.35f) / (this.mPhysicalCoeff * SCROLL_FRICTION));
    ...
    */
            ...
            if (actionMasked == 1) {
                ...
                if (iFindPointerIndex == -1) {
                    ...
                    if (this.mIsBeingDragged) {
                        int iScrollBy = scrollBy(i4, 1, motionEvent, (int) motionEvent.getX(iFindPointerIndex), 0, false);
    ...
    @VisibleForTesting
    public int scrollBy(int i2, int i3, MotionEvent motionEvent, int i4, int i5, boolean z2) {
        int i6;
        int i7;
        ...
        boolean z3 = false;
        if (dispatchNestedPreScroll(0, i2, this.mScrollConsumed, this.mScrollOffset, i5)) {
            i6 = i2 - this.mScrollConsumed[1];
        ...
        int[] iArr = this.mScrollConsumed;
        iArr[1] = 0;
        dispatchNestedScroll(0, scrollY2, 0, i6 - scrollY2, this.mScrollOffset, i5, iArr);
        int i8 = i7 + this.mScrollOffset[1];

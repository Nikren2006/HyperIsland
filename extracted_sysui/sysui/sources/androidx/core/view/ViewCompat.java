...
public class ViewCompat {
    ...
    private static final OnReceiveContentViewBehavior NO_OP_ON_RECEIVE_CONTENT_VIEW_BEHAVIOR = new OnReceiveContentViewBehavior() { // from class: androidx.core.view.j
    ...
    public static <T extends View> T requireViewById(View view, @IdRes int i2) {
    ...
    @Deprecated
    public static void setPaddingRelative(View view, @Px int i2, @Px int i3, @Px int i4, @Px int i5) {

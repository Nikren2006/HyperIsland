...
public final class BundleKt {
    public static final Bundle bundleOf(i... iVarArr) {
        ...
        for (i iVar : iVarArr) {
            ...
            if (objB == null) {
                ...
                if (Parcelable.class.isAssignableFrom(componentType)) {
                    n.e(objB, "null cannot be cast to non-null type kotlin.Array<android.os.Parcelable>");
                    bundle.putParcelableArray(str, (Parcelable[]) objB);
                } else if (String.class.isAssignableFrom(componentType)) {
                    n.e(objB, "null cannot be cast to non-null type kotlin.Array<kotlin.String>");
                    bundle.putStringArray(str, (String[]) objB);
                } else if (CharSequence.class.isAssignableFrom(componentType)) {
                    n.e(objB, "null cannot be cast to non-null type kotlin.Array<kotlin.CharSequence>");

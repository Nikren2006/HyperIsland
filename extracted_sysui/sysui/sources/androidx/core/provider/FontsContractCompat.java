...
public class FontsContractCompat {
    ...
    public static class FontInfo {
        ...
        @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP_PREFIX})
        @Deprecated
        public FontInfo(Uri uri, @IntRange(from = 0) int i2, @IntRange(from = 1, to = 1000) int i3, boolean z2, int i4) {
        ...
        public static FontInfo create(Uri uri, @IntRange(from = 0) int i2, @IntRange(from = 1, to = 1000) int i3, boolean z2, int i4) {
    ...
    public static Typeface getFontSync(Context context, FontRequest fontRequest, ResourcesCompat.FontCallback fontCallback, Handler handler, boolean z2, int i2, int i3) {
        ...
        return requestFont(context, (List<FontRequest>) List.of(fontRequest), i3, z2, i2, ResourcesCompat.FontCallback.getHandler(handler), resourcesCallbackAdapter);
    }
    ...
    public static void requestFont(Context context, FontRequest fontRequest, int i2, Executor executor, Executor executor2, FontRequestCallback fontRequestCallback) {
        FontRequestWorker.requestFontAsync(context.getApplicationContext(), List.of(fontRequest), i2, executor, new CallbackWrapper(fontRequestCallback, executor2));
    }
    ...
    public static Typeface requestFont(Context context, FontRequest fontRequest, int i2, boolean z2, @IntRange(from = 0) int i3, Handler handler, FontRequestCallback fontRequestCallback) {
        return requestFont(context, (List<FontRequest>) List.of(fontRequest), i2, z2, i3, handler, fontRequestCallback);
    }
}

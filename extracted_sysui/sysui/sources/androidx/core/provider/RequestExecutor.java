...
class RequestExecutor {
    ...
    public static ThreadPoolExecutor createDefaultExecutor(String str, int i2, @IntRange(from = 0) int i3) {
    ...
    public static <T> T submit(ExecutorService executorService, Callable<T> callable, @IntRange(from = 0) int i2) throws InterruptedException {
        try {
            ...
            throw new InterruptedException(Const.Param.TIMEOUT_MIN);
        }
    }
}

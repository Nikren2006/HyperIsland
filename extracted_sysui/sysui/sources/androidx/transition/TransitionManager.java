...
public class TransitionManager {
    ...
    private static void changeScene(Scene scene, Transition transition) {
        ...
        Transition transitionMo47clone = transition.mo47clone();
        if (currentScene != null && currentScene.isCreatedFromLayoutResource()) {
            transitionMo47clone.setCanRemoveViews(true);
        }
        sceneChangeSetup(sceneRoot, transitionMo47clone);
        scene.enter();
        sceneChangeRunTransition(sceneRoot, transitionMo47clone);
    }
    ...
    public static void beginDelayedTransition(@NonNull ViewGroup viewGroup, @Nullable Transition transition) {
        ...
        Transition transitionMo47clone = transition.mo47clone();
        sceneChangeSetup(viewGroup, transitionMo47clone);
        Scene.setCurrentScene(viewGroup, null);
        sceneChangeRunTransition(viewGroup, transitionMo47clone);
    }

...
public abstract class AbstractResolvableFuture<V> implements a {
    ...
    public static final class SetFuture<V> implements Runnable {
        ...
        public SetFuture(AbstractResolvableFuture<V> abstractResolvableFuture, a aVar) {
    ...
    static {
        ...
        try {
            synchronizedHelper = new SafeAtomicHelper(AtomicReferenceFieldUpdater.newUpdater(Waiter.class, Thread.class, "thread"), AtomicReferenceFieldUpdater.newUpdater(Waiter.class, Waiter.class, MiPlayEventsKt.POSITION_NEXT), AtomicReferenceFieldUpdater.newUpdater(AbstractResolvableFuture.class, Waiter.class, "waiters"), AtomicReferenceFieldUpdater.newUpdater(AbstractResolvableFuture.class, Listener.class, "listeners"), AtomicReferenceFieldUpdater.newUpdater(AbstractResolvableFuture.class, Object.class, ah.f2836p));
            th = null;
        } catch (Throwable th) {
            th = th;

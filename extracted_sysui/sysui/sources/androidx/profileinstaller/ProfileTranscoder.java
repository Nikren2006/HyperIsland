...
class ProfileTranscoder {
    ...
    private static byte[] createMethodBitmapRegionForS(int i2, @NonNull DexProfileData dexProfileData) throws IOException {
        ByteArrayOutputStream byteArrayOutputStream = new ByteArrayOutputStream();
        try {
    ...
    private static String enforceSeparator(@NonNull String str, @NonNull String str2) {
        return AlphabetIndexer.STARRED_TITLE.equals(str2) ? str.replace(MethodCodeHelper.IDENTITY_INFO_SEPARATOR, AlphabetIndexer.STARRED_TITLE) : MethodCodeHelper.IDENTITY_INFO_SEPARATOR.equals(str2) ? str.replace(AlphabetIndexer.STARRED_TITLE, MethodCodeHelper.IDENTITY_INFO_SEPARATOR) : str;
    }

    @NonNull
    private static String extractKey(@NonNull String str) {
        int iIndexOf = str.indexOf(AlphabetIndexer.STARRED_TITLE);
        if (iIndexOf < 0) {
            iIndexOf = str.indexOf(MethodCodeHelper.IDENTITY_INFO_SEPARATOR);
        }
    ...
    private static String generateDexKey(@NonNull String str, @NonNull String str2, @NonNull byte[] bArr) {
        ...
        if (str2.contains(AlphabetIndexer.STARRED_TITLE) || str2.contains(MethodCodeHelper.IDENTITY_INFO_SEPARATOR)) {
            return enforceSeparator(str2, strDexKeySeparator);
        }
    ...
    private static void writeMethodBitmapForS(@NonNull OutputStream outputStream, int i2, @NonNull DexProfileData dexProfileData) throws IOException {
        ...
        for (Map.Entry<Integer, Integer> entry : dexProfileData.methods.entrySet()) {
            ...
            for (int i4 = 1; i4 <= 4; i4 <<= 1) {
                if (i4 != 1 && (i4 & i2) != 0) {
                    if ((i4 & iIntValue2) == i4) {
                        int i5 = (dexProfileData.numMethodIds * i3) + iIntValue;
                        int i6 = i5 / 8;

...
public class ExifInterface {
    ...
    static {
        ...
        EXIF_POINTER_TAGS = new ExifTag[]{new ExifTag(TAG_SUB_IFD_POINTER, ResponsivePolicy.THRESHOLD_FLIP_OUT_WINDOW, 4), new ExifTag(TAG_EXIF_IFD_POINTER, 34665, 4), new ExifTag(TAG_GPS_INFO_IFD_POINTER, 34853, 4), new ExifTag(TAG_INTEROPERABILITY_IFD_POINTER, 40965, 4), new ExifTag(TAG_ORF_CAMERA_SETTINGS_IFD_POINTER, 8224, 1), new ExifTag(TAG_ORF_IMAGE_PROCESSING_IFD_POINTER, 8256, 1)};
    ...
    private static double convertRationalLatLonToDouble(String str, String str2) {
        try {
            String[] strArrSplit = str.split(aa.f3429b, -1);
    ...
    private void getHeifAttributes(final SeekableByteOrderedDataInputStream seekableByteOrderedDataInputStream) throws IOException {
        ...
        try {
            try {
                ...
                if (DEBUG) {
                    Log.d(TAG, "Heif meta: " + strExtractMetadata + AnimatedProperty.PROPERTY_NAME_X + strExtractMetadata2 + ", rotation " + strExtractMetadata3);
                }
        ...
        if (str != null && NON_ZERO_TIME_PATTERN.matcher(str).matches()) {
            ...
            try {
                ...
                if (str3 != null) {
                    ...
                    if (("+".equals(strSubstring) || "-".equals(strSubstring)) && MethodCodeHelper.IDENTITY_INFO_SEPARATOR.equals(str3.substring(3, 4)) && i3 <= 14) {
    ...
    */
    ...
    /* JADX WARN: Removed duplicated region for block: B:74:0x0101 A[Catch: all -> 0x0111, Exception -> 0x0115, TryCatch #19 {Exception -> 0x0115, all -> 0x0111, blocks: (B:72:0x00fd, B:74:0x0101, B:81:0x0120, B:80:0x0118), top: B:130:0x00fd }] */
    /* JADX WARN: Removed duplicated region for block: B:80:0x0118 A[Catch: all -> 0x0111, Exception -> 0x0115, TryCatch #19 {Exception -> 0x0115, all -> 0x0111, blocks: (B:72:0x00fd, B:74:0x0101, B:81:0x0120, B:80:0x0118), top: B:130:0x00fd }] */
    ...
    */
    ...
    public void setAttribute(@NonNull String str, @Nullable String str2) {
        ...
        if (("DateTime".equals(str3) || TAG_DATETIME_ORIGINAL.equals(str3) || TAG_DATETIME_DIGITIZED.equals(str3)) && strReplaceAll != null) {
            ...
            if (zFind2) {
                strReplaceAll = strReplaceAll.replaceAll("-", MethodCodeHelper.IDENTITY_INFO_SEPARATOR);
            }
        }
            ...
            if ((i7 != 4 || this.mHasThumbnail) && (exifTag = sExifTagMapsForWriting[i7].get(str3)) != null) {
                if (strReplaceAll != null) {
                    ...
                    switch (i2) {
                        ...
                        case 3:
                            i3 = i5;
                            String[] strArrSplit = strReplaceAll.split(aa.f3429b, -1);
                        ...
                        case 4:
                            i3 = i5;
                            String[] strArrSplit2 = strReplaceAll.split(aa.f3429b, -1);
                            ...
                            break;
                        case 5:
                            String[] strArrSplit3 = strReplaceAll.split(aa.f3429b, -1);
                        ...
                        default:
                            ...
                            break;
                        case 9:
                            String[] strArrSplit5 = strReplaceAll.split(aa.f3429b, -1);
                            ...
                            break;
                        case 10:
                            String[] strArrSplit6 = strReplaceAll.split(aa.f3429b, -1);
                            ...
                            break;
                        case 12:
                            String[] strArrSplit8 = strReplaceAll.split(aa.f3429b, -1);
    ...
    public void setDateTime(@NonNull Long l2) {
        ...
        setAttribute("DateTime", sFormatterPrimary.format(new Date(l2.longValue())));

    ...
    */
    ...
    public static void calculateFragments(BackStackRecord backStackRecord, SparseArray<FragmentContainerTransition> sparseArray, boolean z2) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            addToFirstInLastOut(backStackRecord, backStackRecord.mOps.get(i2), sparseArray, false, z2);
        }
    }
    ...
    public static void startTransitions(@NonNull Context context, @NonNull FragmentContainer fragmentContainer, ArrayList<BackStackRecord> arrayList, ArrayList<Boolean> arrayList2, int i2, int i3, boolean z2, Callback callback) {
        ViewGroup viewGroup;

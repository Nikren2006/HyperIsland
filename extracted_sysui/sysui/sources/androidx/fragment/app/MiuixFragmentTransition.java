...
class MiuixFragmentTransition {
    ...
    static final FragmentTransitionImpl MIUIX_IMPL = new MiuixFragmentTransitionSupport();

    private MiuixFragmentTransition() {
    }
    ...
    public static boolean supportsTransition() {
        return (PLATFORM_IMPL == null && SUPPORT_IMPL == null && MIUIX_IMPL == null) ? false : true;
    }
}

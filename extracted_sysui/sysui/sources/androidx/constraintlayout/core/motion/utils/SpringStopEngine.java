...
public class SpringStopEngine implements StopEngine {
    ...
    public void log(String str) {
        ...
        String str2 = ".(" + stackTraceElement.getFileName() + MethodCodeHelper.IDENTITY_INFO_SEPARATOR + stackTraceElement.getLineNumber() + ") " + stackTraceElement.getMethodName() + "() ";

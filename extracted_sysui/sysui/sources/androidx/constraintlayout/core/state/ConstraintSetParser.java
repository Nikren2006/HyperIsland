...
public class ConstraintSetParser {
    ...
    public static class FiniteGenerator implements GeneratedValue {
        ...
        public ArrayList<String> array() {
            ...
            int i4 = i2;
            while (i2 <= i3) {
                arrayList.add(this.mPrefix + i4 + this.mPostfix);
                i4 += (int) this.mStep;
                i2++;
            }
            return arrayList;
    ...
    public static class LayoutVariables {
        ...
        public void putOverride(String str, float f2) {
            this.mGenerators.put(str, new OverrideValue(f2));
        }

        public void put(String str, float f2, float f3) {
            if (this.mGenerators.containsKey(str) && (this.mGenerators.get(str) instanceof OverrideValue)) {
                return;
            }
            this.mGenerators.put(str, new Generator(f2, f3));
        }

        public void put(String str, float f2, float f3, float f4, String str2, String str3) {
            if (this.mGenerators.containsKey(str) && (this.mGenerators.get(str) instanceof OverrideValue)) {
                return;
            }
    ...
    public static void applyAttribute(State state, LayoutVariables layoutVariables, ConstraintReference constraintReference, CLObject cLObject, String str) throws CLParsingException {
        ...
        switch (str) {
            ...
            case "hRtlBias":
                ...
                constraintReference.horizontalBias(f2);
                break;
            case "vWeight":
                ...
                case "contains":
                    ...
                    if (arrayOrNull != null) {
                        for (int i2 = 0; i2 < arrayOrNull.size(); i2++) {
                            barrierReferenceBarrier.add(state.constraints(arrayOrNull.get(i2).content()));
                        }
                        break;
                    } else {
                        break;
    ...
    */
    ...
    /* JADX WARN: Type update failed for variable: r23v0 ??, new type: androidx.constraintlayout.core.state.ConstraintReference
    ...
    */
    ...
    public static Dimension parseDimension(CLObject cLObject, String str, State state, CorePixelDp corePixelDp) throws CLParsingException {
        ...
        CLObject cLObject2 = (CLObject) cLElement;
        String stringOrNull = cLObject2.getStringOrNull(ah.f2836p);
        if (stringOrNull != null) {
    ...
    public static Dimension parseDimensionMode(String str) {
        ...
        switch (str) {
            ...
            default:
                return str.endsWith("%") ? Dimension.createPercent(0, Float.parseFloat(str.substring(0, str.indexOf(37))) / 100.0f).suggested(0) : str.contains(MethodCodeHelper.IDENTITY_INFO_SEPARATOR) ? Dimension.createRatio(str).suggested(Dimension.SPREAD_DIMENSION) : dimensionCreateFixed;
        }
    }
    ...
    */
    ...
    public static void parseGuideline(int i2, State state, CLArray cLArray) throws CLParsingException {
        ...
        if ((cLElement instanceof CLObject) && (stringOrNull = (cLObject = (CLObject) cLElement).getStringOrNull(Column.ID)) != null) {
                ...
                if ((cLElement instanceof CLObject) && (objectOrNull = ((CLObject) cLElement).getObjectOrNull("custom")) != null) {
                    for (String str3 : objectOrNull.names()) {
                        ...
                        if (cLElement2 instanceof CLNumber) {
                            transition.addCustomFloat(i2, str2, str3, cLElement2.getFloat());
                        } else if (cLElement2 instanceof CLString) {
                            long colorString = parseColorString(cLElement2.content());
                            if (colorString != -1) {
                                transition.addCustomColor(i2, str2, str3, (int) colorString);
                            }
                        }
                    }
                }
        ...
        if (cLElement instanceof CLObject) {
            ...
            for (String str : arrayListNames) {
                ...
                switch (str) {
                    ...
                    case "pathArc":
                        String string = cLObject.getString(str);
                        int iIndexOf = indexOf(string, "none", "startVertical", "startHorizontal", DynamicIslandEventsConstants.Other.PHONE_TYPE_FLIP, "below", "above");
                        if (iIndexOf != -1) {
    ...
    */
        ...
        for (String str : arrayListNames) {
            ...
            if (cLElement instanceof CLNumber) {
                ...
                if (cLObject2.has("from") && cLObject2.has("to")) {
                    layoutVariables.put(str, layoutVariables.get(cLObject2.get("from")), layoutVariables.get(cLObject2.get("to")), 1.0f, cLObject2.getStringOrNull("prefix"), cLObject2.getStringOrNull("postfix"));
    ...
    private static float toPix(State state, float f2) {
        return state.getDpToPixel().toPixels(f2);
    }

...
public class WidgetFrame {
    ...
    public static void interpolate(int i2, int i3, WidgetFrame widgetFrame, WidgetFrame widgetFrame2, WidgetFrame widgetFrame3, Transition transition, float f2) {
        ...
        if (widgetFrame.widget == null || !transition.hasPositionKeyframes()) {
            ...
            if (keyPositionFindPreviousPosition != null) {
                i6 = (int) (keyPositionFindPreviousPosition.mX * i2);
                i11 = i17;
                i10 = i3;
                i7 = (int) (keyPositionFindPreviousPosition.mY * i10);
                i12 = keyPositionFindPreviousPosition.mFrame;
            } else {
                i10 = i3;
                i11 = i17;
                i12 = 0;
            ...
            if (keyPositionFindNextPosition != null) {
                i9 = (int) (keyPositionFindNextPosition.mX * i2);
                i18 = (int) (keyPositionFindNextPosition.mY * i10);
                i13 = keyPositionFindNextPosition.mFrame;
            } else {
                i13 = 100;
                i9 = i11;
            }
        ...
        widgetFrame.top = i25;
        float f11 = 1.0f - f2;
        widgetFrame.right = i24 + ((int) ((i4 * f11) + (i21 * f2)));
        widgetFrame.bottom = i25 + ((int) ((f11 * i5) + (i22 * f2)));
    ...
    public void logv(String str) {
        ...
        String str3 = (".(" + stackTraceElement.getFileName() + MethodCodeHelper.IDENTITY_INFO_SEPARATOR + stackTraceElement.getLineNumber() + ") " + stackTraceElement.getMethodName()) + " " + (hashCode() % 1000);
        if (this.widget != null) {
    ...
    public void printCustomAttributes() {
        StackTraceElement stackTraceElement = new Throwable().getStackTrace()[1];
        String str = (".(" + stackTraceElement.getFileName() + MethodCodeHelper.IDENTITY_INFO_SEPARATOR + stackTraceElement.getLineNumber() + ") " + stackTraceElement.getMethodName()) + " " + (hashCode() % 1000);

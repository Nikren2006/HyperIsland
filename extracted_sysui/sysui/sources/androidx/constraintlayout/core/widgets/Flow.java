    ...
    private void measureChainWrap(ConstraintWidget[] constraintWidgetArr, int i2, int i3, int i4, int[] iArr) {
        ...
        if (i3 == 0) {
            ...
            while (i10 < i2) {
                ...
                int i11 = i5;
                boolean z2 = (i9 == i4 || (this.mHorizontalGap + i9) + widgetWidth > i4) && widgetsList.mBiggest != null;
            ...
            while (i13 < i2) {
                ...
                int i14 = i5;
                boolean z3 = (i12 == i4 || (this.mVerticalGap + i12) + widgetHeight > i4) && widgetsList.mBiggest != null;
        ...
        while (i18 < size) {
            ...
            if (i3 == 0) {
                if (i18 < size - 1) {
                    constraintAnchor2 = this.mChainList.get(i18 + 1).mBiggest.mTop;
                    paddingBottom = 0;
                } else {
                ...
                i7 = i18;
                if (i7 < size - 1) {
                    constraintAnchor = this.mChainList.get(i7 + 1).mBiggest.mLeft;
                    paddingRight = 0;
                } else {
    ...
    private void measureChainWrap_new(ConstraintWidget[] constraintWidgetArr, int i2, int i3, int i4, int[] iArr) {
        ...
        if (i3 == 0) {
            ...
            while (i11 < i2) {
                ...
                int i12 = i5;
                boolean z2 = (i10 == i4 || (this.mHorizontalGap + i10) + widgetWidth > i4) && widgetsList.mBiggest != null;
                if (!z2 && i11 > 0 && (i8 = this.mMaxElementsWrap) > 0 && i9 > i8) {
                    z2 = true;
                }
                if (z2) {
                    widgetsList = new WidgetsList(i3, this.mLeft, this.mTop, this.mRight, this.mBottom, i4);
            ...
            while (i15 < i2) {
                ...
                int i16 = i5;
                boolean z3 = (i14 == i4 || (this.mVerticalGap + i14) + widgetHeight > i4) && widgetsList.mBiggest != null;
                if (!z3 && i15 > 0 && (i6 = this.mMaxElementsWrap) > 0 && i13 > i6) {
                    z3 = true;
                }
                if (z3) {
                    widgetsList = new WidgetsList(i3, this.mLeft, this.mTop, this.mRight, this.mBottom, i4);
                    ...
                    i14 = i15 > 0 ? i14 + this.mVerticalGap + widgetHeight : widgetHeight;
                }
                widgetsList.add(constraintWidget2);
                i15++;
                i5 = i16;
        ...
        while (i20 < size) {
            ...
            if (i3 == 0) {
                if (i20 < size - 1) {
                    constraintAnchor2 = this.mChainList.get(i20 + 1).mBiggest.mTop;
                    paddingBottom = 0;
                } else {
                    constraintAnchor2 = this.mBottom;
                    paddingBottom = getPaddingBottom();

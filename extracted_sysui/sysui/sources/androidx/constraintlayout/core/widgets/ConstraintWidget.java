...
public class ConstraintWidget {
    ...
    /* JADX WARN: Removed duplicated region for block: B:367:0x0568  */
    ...
    */
    ...
    private void serializeCircle(StringBuilder sb, ConstraintAnchor constraintAnchor, float f2) {
        if (constraintAnchor.mTarget == null || Float.isNaN(f2)) {
            return;
        }
        sb.append("circle : [ '");
        sb.append(constraintAnchor.mTarget);
    ...
    private void serializeSize(StringBuilder sb, String str, int i2, int i3, int i4, int i5, int i6, int i7, float f2, float f3) {
        ...
        serializeAttribute(sb, "matchConstraintPercent", f2, 1.0f);
        serializeAttribute(sb, "weight", f3, 1.0f);
        serializeAttribute(sb, "override", i5, 1);
        sb.append("},\n");
    }
    ...
    */
    ...
    public void updateFromRuns(boolean z2, boolean z3) {
        ...
        boolean zIsResolved2 = z3 & this.mVerticalRun.isResolved();
    ...
    private void getSceneString(StringBuilder sb, String str, int i2, int i3, int i4, int i5, int i6, int i7, float f2, DimensionBehaviour dimensionBehaviour, float f3) {
        sb.append(str);
        sb.append(" :  {\n");

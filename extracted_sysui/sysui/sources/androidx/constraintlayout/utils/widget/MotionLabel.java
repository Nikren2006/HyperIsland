...
public class MotionLabel extends View implements FloatLayout {
    ...
    public void buildShape(float f2) {
        if (this.mUseOutline || f2 != 1.0f) {
            ...
            if (f2 != 1.0f) {
                Log.v(TAG, Debug.getLoc() + " scale " + f2);
        ...
        if (this.mAutoSize) {
            ...
            if (zIsNaN) {
                ...
                if (f5 * f4 > f6 * f3) {
                    ...
                    this.mPaint.setTextSize((this.mPaintTextSize * f4) / f6);
                }
            } else {
                float f7 = iWidth;
                float f8 = iHeight;
    ...
    public void layout(float f2, float f3, float f4, float f5) {
        ...
        if (this.mAutoSize) {
            ...
            if (fWidth * f9 > fHeight * f8) {
                this.mPaint.setTextSize((this.mPaintTextSize * f8) / fWidth);
            } else {
                this.mPaint.setTextSize((this.mPaintTextSize * f9) / fHeight);
            }

...
public class MotionLayout extends ConstraintLayout implements NestedScrollingParent3 {
    ...
    public class DevModeDraw {
        ...
        public void draw(Canvas canvas, HashMap<View, MotionController> map, int i2, int i3) {
            ...
            if (!MotionLayout.this.isInEditMode() && (i3 & 1) == 2) {
                String str = MotionLayout.this.getContext().getResources().getResourceName(MotionLayout.this.mEndState) + MethodCodeHelper.IDENTITY_INFO_SEPARATOR + MotionLayout.this.getProgress();
    ...
    public class Model {
        ...
        private void debugLayout(String str, ConstraintWidgetContainer constraintWidgetContainer) {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                ...
                sb2.append(string);
                sb2.append(constraintWidget.mBottom.mTarget != null ? ai.f2847a : "_");
        ...
        private void debugWidget(String str, ConstraintWidget constraintWidget) {
            ...
            String str2 = ai.f2847a;
            String string4 = "__";
            if (constraintAnchor != null) {
                StringBuilder sb2 = new StringBuilder();
                sb2.append(ExifInterface.GPS_DIRECTION_TRUE);
                sb2.append(constraintWidget.mTop.mTarget.mType == ConstraintAnchor.Type.TOP ? ExifInterface.GPS_DIRECTION_TRUE : ai.f2847a);
                string = sb2.toString();
            } else {
                string = "__";
            }
    ...
    private void fireTransitionChange() {
        ...
        if (transitionListener != null) {
            transitionListener.onTransitionChange(this, this.mBeginState, this.mEndState, f2);
        }

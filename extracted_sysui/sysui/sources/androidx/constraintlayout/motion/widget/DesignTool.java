...
public class DesignTool {
    ...
    private static void connect(int i2, ConstraintSet constraintSet, View view, HashMap<String, String> map, int i3, int i4) {
        String str = sAllAttributes.get(Pair.create(Integer.valueOf(i3), Integer.valueOf(i4)));
    ...
    private static void setDimensions(int i2, ConstraintSet constraintSet, View view, HashMap<String, String> map, int i3) {
        ...
        if (str != null) {
            int pxFromDp = !str.equalsIgnoreCase("wrap_content") ? getPxFromDp(i2, str) : -2;
            if (i3 == 0) {
    ...
    public void dumpConstraintSet(String str) {
        ...
        try {
            ...
            Log.e(TAG, "Error while dumping: " + str + " (" + iLookUpConstraintId + ")", e2);
        }
    }
    ...
    public void setAttributes(int i2, String str, Object obj, Object obj2) {
        ...
        HashMap map2 = map;
        connect(i2, constraintSet, view, map2, 6, 6);
        connect(i2, constraintSet, view, map2, 6, 7);
        connect(i2, constraintSet, view, map2, 7, 7);
        connect(i2, constraintSet, view, map2, 7, 6);
        connect(i2, constraintSet, view, map2, 1, 1);
        connect(i2, constraintSet, view, map2, 1, 2);
        connect(i2, constraintSet, view, map2, 2, 2);
        connect(i2, constraintSet, view, map2, 2, 1);
        connect(i2, constraintSet, view, map2, 3, 3);
        connect(i2, constraintSet, view, map2, 3, 4);
        connect(i2, constraintSet, view, map2, 4, 3);
        connect(i2, constraintSet, view, map2, 4, 4);
        connect(i2, constraintSet, view, map2, 5, 5);

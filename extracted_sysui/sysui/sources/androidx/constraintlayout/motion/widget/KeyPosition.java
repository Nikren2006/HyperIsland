...
public class KeyPosition extends KeyPositionBase {
    ...
    public void positionAttributes(View view, RectF rectF, RectF rectF2, float f2, float f3, String[] strArr, float[] fArr) {
        ...
        if (i2 == 2) {
            ...
            positionAxisAttributes(rectF, rectF2, f2, f3, strArr, fArr);
        }
    }

    public void positionAxisAttributes(RectF rectF, RectF rectF2, float f2, float f3, String[] strArr, float[] fArr) {
        ...
        float f4 = fCenterX2 - fCenterX;
        float f5 = fCenterY - fCenterY2;
        String str = strArr[0];
        if (str == null) {
            strArr[0] = "percentX";
            fArr[0] = (f2 - fCenterX) / f4;
            strArr[1] = "percentY";
            fArr[1] = (f3 - fCenterY2) / f5;
            return;
        }
        if ("percentX".equals(str)) {
            ...
            fArr[1] = (f2 - fCenterX) / f4;
            fArr[0] = (f3 - fCenterY2) / f5;
        }
    }

...
public class Debug {
    public static void dumpLayoutParams(ViewGroup viewGroup, String str) {
        ...
        String str2 = ".(" + stackTraceElement.getFileName() + MethodCodeHelper.IDENTITY_INFO_SEPARATOR + stackTraceElement.getLineNumber() + ") " + str + "  ";
        ...
        for (int i2 = 0; i2 < childCount; i2++) {
            ...
            for (int i3 = 0; i3 < fields.length; i3++) {
                ...
                try {
                    ...
                    if (field.getName().contains("To") && !obj.toString().equals(MiPlayEventsKt.DEVICE_IF_CACHE_NULL)) {
    ...
    public static void dumpPoc(Object obj) {
        StackTraceElement stackTraceElement = new Throwable().getStackTrace()[1];
        String str = ".(" + stackTraceElement.getFileName() + MethodCodeHelper.IDENTITY_INFO_SEPARATOR + stackTraceElement.getLineNumber() + ")";
        Class<?> cls = obj.getClass();
        System.out.println(str + "------------- " + cls.getName() + " --------------------");
        for (Field field : cls.getFields()) {
            try {
                Object obj2 = field.get(obj);
                if (field.getName().startsWith("layout_constraint") && ((!(obj2 instanceof Integer) || !obj2.toString().equals(MiPlayEventsKt.DEVICE_IF_CACHE_NULL)) && ((!(obj2 instanceof Integer) || !obj2.toString().equals("0")) && ((!(obj2 instanceof Float) || !obj2.toString().equals("1.0")) && (!(obj2 instanceof Float) || !obj2.toString().equals("0.5")))))) {
    ...
    public static String getCallFrom(int i2) {
        ...
        return ".(" + stackTraceElement.getFileName() + MethodCodeHelper.IDENTITY_INFO_SEPARATOR + stackTraceElement.getLineNumber() + ")";
    }

    public static String getLoc() {
        StackTraceElement stackTraceElement = new Throwable().getStackTrace()[1];
        return ".(" + stackTraceElement.getFileName() + MethodCodeHelper.IDENTITY_INFO_SEPARATOR + stackTraceElement.getLineNumber() + ") " + stackTraceElement.getMethodName() + "()";
    }
    ...
    public static void logStack(String str, String str2, int i2) {
        ...
        for (int i3 = 1; i3 <= iMin; i3++) {
            ...
            str3 = str3 + " ";
            Log.v(str, str2 + str3 + (".(" + stackTrace[i3].getFileName() + MethodCodeHelper.IDENTITY_INFO_SEPARATOR + stackTrace[i3].getLineNumber() + ") " + stackTrace[i3].getMethodName()) + str3);
        }
    }
    ...
    public static void printStack(String str, int i2) {
        ...
        for (int i3 = 1; i3 <= iMin; i3++) {
            StackTraceElement stackTraceElement = stackTrace[i3];
            String str3 = ".(" + stackTrace[i3].getFileName() + MethodCodeHelper.IDENTITY_INFO_SEPARATOR + stackTrace[i3].getLineNumber() + ") ";
            str2 = str2 + " ";
    ...
    public static void dumpLayoutParams(ViewGroup.LayoutParams layoutParams, String str) {
        ...
        for (Field field : layoutParams.getClass().getFields()) {
            try {
                ...
                if (name.contains("To") && !obj.toString().equals(MiPlayEventsKt.DEVICE_IF_CACHE_NULL)) {

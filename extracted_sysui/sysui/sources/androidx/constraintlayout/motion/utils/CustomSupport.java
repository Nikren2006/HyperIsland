...
public class CustomSupport {
    ...
    public static void setInterpolatedValue(ConstraintAttribute constraintAttribute, View view, float[] fArr) {
        ...
        try {
            ...
            Log.e(TAG, "Cannot access method " + str + " on View \"" + Debug.getName(view) + "\"", e2);
        } catch (NoSuchMethodException e3) {
            Log.e(TAG, "No method " + str + " on View \"" + Debug.getName(view) + "\"", e3);
        } catch (InvocationTargetException e4) {
            Log.e(TAG, "Cannot invoke method " + str + " on View \"" + Debug.getName(view) + "\"", e4);
        }
    }
}

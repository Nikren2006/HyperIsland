...
public class ConstraintAttribute {
    ...
    public static HashMap<String, ConstraintAttribute> extractAttributes(HashMap<String, ConstraintAttribute> map, View view) {
        ...
        for (String str : map.keySet()) {
            ...
            try {
                ...
                Log.e(TAG, " Custom Attribute \"" + str + "\" not found on " + cls.getName(), e2);
            } catch (NoSuchMethodException e3) {
                Log.e(TAG, cls.getName() + " must have a method " + str, e3);
            } catch (InvocationTargetException e4) {
                Log.e(TAG, " Custom Attribute \"" + str + "\" not found on " + cls.getName(), e4);
            }
        }
        return map2;
    }
    ...
    public static void setAttributes(View view, HashMap<String, ConstraintAttribute> map) {
        ...
        for (String str : map.keySet()) {
            ...
            try {
                ...
                Log.e(TAG, cls.getName() + " must have a method " + str2, e3);
            } catch (InvocationTargetException e4) {
                Log.e(TAG, " Custom Attribute \"" + str + "\" not found on " + cls.getName(), e4);
            }
        }
    ...
    public void applyCustom(View view) {
        ...
        try {
            ...
            Log.e(TAG, " Custom Attribute \"" + str2 + "\" not found on " + cls.getName(), e2);
        } catch (NoSuchMethodException e3) {
            Log.e(TAG, cls.getName() + " must have a method " + str, e3);
        } catch (InvocationTargetException e4) {
            Log.e(TAG, " Custom Attribute \"" + str2 + "\" not found on " + cls.getName(), e4);
        }
    }

...
public class ConstraintSet {
    ...
    public static class Layout {
            ...
            for (Field field : declaredFields) {
                ...
                if (!Modifier.isStatic(field.getModifiers())) {
                    try {
                        ...
                        Log.e(ConstraintSet.TAG, "Error accessing ConstraintSet field", e2);
                    }
                }
            }
        }
        ...
        public void fillFromAttributeList(Context context, AttributeSet attributeSet) {
            ...
            for (int i2 = 0; i2 < indexCount; i2++) {
                ...
                int i3 = sMapToConstant.get(index);
                switch (i3) {
                    case 1:
    ...
    public class WriteXmlEngine {
        ...
        private void writeEnum(String str, int i2, String[] strArr, int i3) throws IOException {
            if (i2 != i3) {
                this.mWriter.write(SPACE + str + "=\"" + strArr[i2] + "\"");
            }
        }

        public String getName(int i2) {
            if (this.mIdMap.containsKey(Integer.valueOf(i2))) {
                return "@+id/" + this.mIdMap.get(Integer.valueOf(i2)) + "";
            }
            if (i2 == 0) {
                return ConstraintSet.KEY_PERCENT_PARENT;
            }
            String strLookup = lookup(i2);
            this.mIdMap.put(Integer.valueOf(i2), strLookup);
            return "@+id/" + strLookup + "";
        }
        ...
        public String lookup(int i2) {
            try {
                ...
                sb2.append("unknown");
                int i4 = this.mUnknownCount + 1;
                this.mUnknownCount = i4;
                sb2.append(i4);
                return sb2.toString();
            }
        }
        ...
        public void writeCircle(int i2, float f2, int i3) throws IOException {
            ...
            this.mWriter.write(":[");
            this.mWriter.write(getName(i2));
            this.mWriter.write(", " + f2);
        ...
        public void writeVariable(String str, int i2) throws IOException {
            ...
            this.mWriter.write(SPACE + str + "=\"" + i2 + "\"\n");
        }
        ...
        public void writeVariable(String str, int[] iArr) throws IOException {
            ...
            this.mWriter.write(SPACE + str);
            this.mWriter.write(MethodCodeHelper.IDENTITY_INFO_SEPARATOR);
            int i2 = 0;
    ...
    static {
        ...
        sOverrideMapToConstant.append(i2, 7);
    ...
    private int[] convertReferenceString(View view, String str) {
        ...
        while (i2 < strArrSplit.length) {
            ...
            if (iIntValue == 0) {
                iIntValue = context.getResources().getIdentifier(strTrim, Column.ID, context.getPackageName());
            }
    ...
    private Constraint fillFromAttributeList(Context context, AttributeSet attributeSet, boolean z2) {
        ...
        populateConstraint(constraint, typedArrayObtainStyledAttributes, z2);
        typedArrayObtainStyledAttributes.recycle();
        return constraint;
    }
        ...
        for (Field field : ConstraintSet.class.getDeclaredFields()) {
            if (field.getName().contains("_") && field.getType() == Integer.TYPE && Modifier.isStatic(field.getModifiers()) && Modifier.isFinal(field.getModifiers())) {
                try {
                    ...
                    Log.e(TAG, "Error accessing ConstraintSet field", e2);
                }
            }
        }
        return "UNKNOWN";
    ...
    */
        ...
        if (str != null) {
            ...
            if (iIndexOf > 0 && iIndexOf < length - 1) {
                ...
                if (strSubstring.equalsIgnoreCase(ExifInterface.LONGITUDE_WEST)) {
                    i2 = 0;
                } else if (strSubstring.equalsIgnoreCase(ai.f2848b)) {
                    i2 = 1;
                }
                i3 = iIndexOf + 1;
            }
    ...
    private void populateConstraint(Constraint constraint, TypedArray typedArray, boolean z2) {
        if (z2) {
    ...
    public void load(Context context, int i2) {
        ...
        try {
            ...
            Log.e(TAG, "Error parsing resource: " + i2, e2);
        } catch (XmlPullParserException e3) {
            Log.e(TAG, "Error parsing resource: " + i2, e3);
        }
    }
    ...
    */
    ...
    public void setStateLabels(String str) {
        this.mMatchLabels = str.split(aa.f3429b);
        int i2 = 0;
        while (true) {
            String[] strArr = this.mMatchLabels;
            if (i2 >= strArr.length) {
    ...
    public class WriteJsonEngine {
        ...
        private void writeDimension(String str, int i2, int i3, float f2, int i4, int i5, boolean z2) throws IOException {
            ...
            if (i5 == -1 && i4 == -1) {
                ...
                this.mWriter.write(SPACE + str + ": '" + f2 + "%',\n");
                return;
            }
            if (i3 == 0) {
                this.mWriter.write(SPACE + str + ": {'spread' ," + i4 + ", " + i5 + "}\n");
                return;
            }
            if (i3 == 1) {
                this.mWriter.write(SPACE + str + ": {'wrap' ," + i4 + ", " + i5 + "}\n");
                return;
            }
            if (i3 != 2) {
                return;
            }
            this.mWriter.write(SPACE + str + ": {'" + f2 + "'% ," + i4 + ", " + i5 + "}\n");
        }

        private void writeGuideline(int i2, int i3, int i4, float f2) throws IOException {
            writeVariable("'orientation'", i2);
            writeVariable("'guideBegin'", i3);
            writeVariable("'guideEnd'", i4);
            writeVariable("'guidePercent'", f2);
        }

        public String getName(int i2) {
            if (this.mIdMap.containsKey(Integer.valueOf(i2))) {
                return "'" + this.mIdMap.get(Integer.valueOf(i2)) + "'";
            }
            if (i2 == 0) {
                return "'parent'";
            }

...
public class ConstraintLayout extends ViewGroup {
    ...
    public class Measurer implements BasicMeasure.Measurer {
        ...
        public void captureLayoutInfo(int i2, int i3, int i4, int i5, int i6, int i7) {
            ...
            this.mPaddingHeight = i7;
            this.mLayoutWidthSpec = i2;
            this.mLayoutHeightSpec = i3;
        }
        ...
        public final void didMeasures() {
            ...
            if (size > 0) {
                for (int i3 = 0; i3 < size; i3++) {
                    ((ConstraintHelper) this.mLayout.mConstraintHelpers.get(i3)).updatePostMeasure(this.mLayout);
                }
            }
        }
    ...
    public interface ValueModifier {
        boolean update(int i2, int i3, int i4, View view, LayoutParams layoutParams);
    }
    ...
    private ConstraintWidget getTargetWidget(int i2) {
        if (i2 == 0) {
    ...
    public void applyConstraintsFromLayoutParams(boolean z2, View view, ConstraintWidget constraintWidget, LayoutParams layoutParams, SparseArray<ConstraintWidget> sparseArray) {
        ...
        if (layoutParams.mIsGuideline) {
            ...
            int i3 = layoutParams.mResolvedGuideBegin;
            int i4 = layoutParams.mResolvedGuideEnd;
        ...
        int i5 = layoutParams.mResolvedLeftToLeft;
        int i6 = layoutParams.mResolvedLeftToRight;
        int i7 = layoutParams.mResolvedRightToLeft;
        int i8 = layoutParams.mResolvedRightToRight;
        int i9 = layoutParams.mResolveGoneLeftMargin;
        int i10 = layoutParams.mResolveGoneRightMargin;
        ...
        if (isInEditMode()) {
            ...
            for (int i3 = 0; i3 < childCount; i3++) {
                ...
                if (childAt.getVisibility() != 8 && (tag = childAt.getTag()) != null && (tag instanceof String)) {
                    String[] strArrSplit = ((String) tag).split(aa.f3429b);
    ...
    public boolean dynamicUpdateConstraints(int i2, int i3) {
    ...
    public void onMeasure(int i2, int i3) {
        ...
        boolean zDynamicUpdateConstraints = this.mDirtyHierarchy | dynamicUpdateConstraints(i2, i3);
    ...
    public void resolveMeasuredDimension(int i2, int i3, int i4, int i5, boolean z2, boolean z3) {
        ...
        int i6 = measurer.mPaddingHeight;
        int iResolveSizeAndState = ViewGroup.resolveSizeAndState(i4 + measurer.mPaddingWidth, i2, 0);
        int iResolveSizeAndState2 = ViewGroup.resolveSizeAndState(i5 + i6, i3, 0);
    ...
    public void resolveSystem(ConstraintWidgetContainer constraintWidgetContainer, int i2, int i3, int i4) {
        ...
        this.mMeasurer.captureLayoutInfo(i3, i4, iMax, iMax2, paddingWidth, i5);

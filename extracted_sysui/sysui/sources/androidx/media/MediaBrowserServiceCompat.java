...
public abstract class MediaBrowserServiceCompat extends Service {
    ...
    public class MediaBrowserServiceImplApi21 implements MediaBrowserServiceImpl {
        ...
        public BrowserRoot onGetRoot(String str, int i2, Bundle bundle) {
            ...
            if (bundle == null || bundle.getInt(MediaBrowserProtocol.EXTRA_CLIENT_VERSION, 0) == 0) {
                ...
                if (token != null) {
                    b bVarS = token.s();
                    BundleCompat.putBinder(extras, MediaBrowserProtocol.EXTRA_SESSION_BINDER, bVarS == null ? null : bVarS.asBinder());
                } else {
                    this.mRootExtrasList.add(extras);
                }
                i3 = bundle.getInt(MediaBrowserProtocol.EXTRA_CALLING_PID, -1);
        ...
        public void setSessionTokenOnHandler(MediaSessionCompat.Token token) {
            if (!this.mRootExtrasList.isEmpty()) {
                ...
                if (bVarS != null) {
                    ...
                    while (it.hasNext()) {
                        BundleCompat.putBinder(it.next(), MediaBrowserProtocol.EXTRA_SESSION_BINDER, bVarS.asBinder());
                    }
                }
                this.mRootExtrasList.clear();
            }
            this.mServiceFwk.setSessionToken((MediaSession.Token) token.t());
        }
    ...
    public class ServiceBinderImpl {
        ...
        public void getMediaItem(final String str, final c.b bVar, final ServiceCallbacks serviceCallbacks) {
        ...
        public void search(final String str, final Bundle bundle, final c.b bVar, final ServiceCallbacks serviceCallbacks) {
            if (TextUtils.isEmpty(str) || bVar == null) {
                return;
            }
        ...
        public void sendCustomAction(final String str, final Bundle bundle, final c.b bVar, final ServiceCallbacks serviceCallbacks) {
            if (TextUtils.isEmpty(str) || bVar == null) {
                return;
            }
        ...
        public void handleMessage(Message message) {
            ...
            switch (message.what) {
                ...
                case 4:
                    ...
                    break;
                case 5:
                    this.mServiceBinderImpl.getMediaItem(data.getString(MediaBrowserProtocol.DATA_MEDIA_ITEM_ID), (c.b) data.getParcelable(MediaBrowserProtocol.DATA_RESULT_RECEIVER), new ServiceCallbacksCompat(message.replyTo));
                    break;
                case 6:
                ...
                case 8:
                    ...
                    this.mServiceBinderImpl.search(data.getString(MediaBrowserProtocol.DATA_SEARCH_QUERY), bundle4, (c.b) data.getParcelable(MediaBrowserProtocol.DATA_RESULT_RECEIVER), new ServiceCallbacksCompat(message.replyTo));
                    break;
                case 9:
                    Bundle bundle5 = data.getBundle(MediaBrowserProtocol.DATA_CUSTOM_ACTION_EXTRAS);
                    MediaSessionCompat.a(bundle5);
                    this.mServiceBinderImpl.sendCustomAction(data.getString(MediaBrowserProtocol.DATA_CUSTOM_ACTION), bundle5, (c.b) data.getParcelable(MediaBrowserProtocol.DATA_RESULT_RECEIVER), new ServiceCallbacksCompat(message.replyTo));
                    break;
                default:
    ...
    public void performCustomAction(String str, Bundle bundle, ConnectionRecord connectionRecord, final c.b bVar) {
    ...
    public void performLoadItem(String str, ConnectionRecord connectionRecord, final c.b bVar) {
    ...
    public void performSearch(String str, Bundle bundle, ConnectionRecord connectionRecord, final c.b bVar) {

...
public class OriginalViewPager extends ViewGroup {
    ...
    private boolean mRestoredCurIsRTL;
    ...
    public interface OnAdapterChangeListener {
        void onAdapterChanged(@NonNull miuix.viewpager.widget.ViewPager viewPager, @Nullable PagerAdapter pagerAdapter, @Nullable PagerAdapter pagerAdapter2);
    }
    ...
    public static class SavedState extends AbsSavedState {
        ...
        public String toString() {
            return "FragmentPager.SavedState{" + Integer.toHexString(System.identityHashCode(this)) + " position=" + this.position + " isRTL=" + this.isRTL + "}";
        }
    ...
    private ItemInfo infoForCurrentScrollPosition() {
        ...
        while (i3 < this.mItems.size()) {
            ...
            if (!z2 && itemInfo2.position != (i2 = i4 + 1)) {
    ...
    */
    ...
    public int convertPositionForRTL(int i2, int i3, boolean z2, boolean z3) {
    ...
    public void initViewPager() {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this, new OnApplyWindowInsetsListener() { // from class: androidx.viewpager.widget.OriginalViewPager.4
            ...
            public WindowInsetsCompat onApplyWindowInsets(View view, WindowInsetsCompat windowInsetsCompat) {
                ...
                for (int i2 = 0; i2 < childCount; i2++) {
                    WindowInsetsCompat windowInsetsCompatDispatchApplyWindowInsets = ViewCompat.dispatchApplyWindowInsets(OriginalViewPager.this.getChildAt(i2), windowInsetsCompatOnApplyWindowInsets);
    ...
    */
    ...
    public void onRestoreInstanceState(Parcelable parcelable) {
        ...
        if (pagerAdapter != null) {
            ...
            setCurrentItemInternal(convertPositionForRTL(this.mAdapter.getCount(), savedState.position, savedState.isRTL > 0, isRTL()), false, true);
        } else {
            this.mRestoredCurItem = savedState.position;
            this.mRestoredCurIsRTL = savedState.isRTL > 0;
    ...
    */
    ...
    public void setAdapter(@Nullable PagerAdapter pagerAdapter) {
        ...
        if (pagerAdapter != null) {
            ...
            if (this.mRestoredCurItem >= 0) {
                ...
                setCurrentItemInternal(convertPositionForRTL(this.mAdapter.getCount(), this.mRestoredCurItem, this.mRestoredCurIsRTL, isRTL()), false, true);
                this.mRestoredCurItem = -1;
                this.mRestoredAdapterState = null;
                this.mRestoredClassLoader = null;
            } else if (z2) {
        ...
        for (int i3 = 0; i3 < size; i3++) {
            this.mAdapterChangeListeners.get(i3).onAdapterChanged((miuix.viewpager.widget.ViewPager) this, pagerAdapter3, pagerAdapter);
        }
    }
    ...
    public void setOffscreenPageLimit(int i2) {
        if (i2 < 2) {
            Log.w(TAG, "Requested offscreen page limit " + i2 + " too small; defaulting to 2");
            i2 = 2;
        }
    ...
    public static class LayoutParams extends ViewGroup.LayoutParams {
        ...
        public LayoutParams(Context context, AttributeSet attributeSet) {
            ...
            this.widthFactor = 0.0f;
            TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, OriginalViewPager.LAYOUT_ATTRS);
    ...
    */
    ...
    public void smoothScrollTo(int i2, int i3, int i4) {
        ...
        if (i2 - scrollX == 0 && i5 == 0) {
            ...
            this.mScroller.startScroll(scrollX, i2, scrollY, i3, -i4);
            ViewCompat.postInvalidateOnAnimation(this);
        }
    }

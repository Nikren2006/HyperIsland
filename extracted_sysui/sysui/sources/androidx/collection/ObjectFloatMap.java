...
public abstract class ObjectFloatMap<K> {
    ...
    public static /* synthetic */ String joinToString$default(ObjectFloatMap objectFloatMap, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i2, CharSequence charSequence4, int i3, Object obj) {
        ...
        return objectFloatMap.joinToString(charSequence, charSequence5, charSequence6, i4, charSequence4);
    }
    ...
    */
    ...
    public final float getOrElse(K k2, Function0 defaultValue) {
    ...
    */
            ...
            while (true) {
                ...
                if ((((~j2) << 7) & j2 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i6 = 0; i6 < i5; i6++) {
                        if ((255 & j2) < 128) {
                            int i7 = (i3 << 3) + i6;
                            if (((Boolean) predicate.invoke(objArr[i7], Float.valueOf(fArr[i7]))).booleanValue()) {
                                i4++;
                            }
                        }
                        j2 >>= 8;
    ...
    public static /* synthetic */ String joinToString$default(ObjectFloatMap objectFloatMap, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i2, CharSequence charSequence4, Function2 transform, int i3, Object obj) {
        long[] jArr;
        long[] jArr2;
        int i4;
        if (obj == null) {
                ...
                if ((((~j2) << 7) & j2 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i8 < i7) {
                        if ((j2 & 255) < 128) {
                            ...
                            sb.append((CharSequence) transform.invoke(obj, Float.valueOf(f2)));
                            i5++;
                            i3 = 8;
                        } else {
                            jArr2 = jArr3;

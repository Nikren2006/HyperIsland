...
public abstract class ObjectLongMap<K> {
    ...
    public static /* synthetic */ String joinToString$default(ObjectLongMap objectLongMap, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i2, CharSequence charSequence4, int i3, Object obj) {
        ...
        return objectLongMap.joinToString(charSequence, charSequence5, charSequence6, i4, charSequence4);
    }
    ...
    */
    ...
    public final int findKeyIndex(K k2) {
        ...
        while (true) {
            ...
            for (long j4 = (~j3) & (j3 - ScatterMapKt.BitmaskLsb) & (-9187201950435737472L); j4 != 0; j4 &= j4 - 1) {
                ...
                if (n.c(this.keys[iNumberOfTrailingZeros], k2)) {
    ...
    public final long getOrElse(K k2, Function0 defaultValue) {
    ...
    */
            ...
            while (true) {
                ...
                if ((((~j2) << 7) & j2 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i6 = 0; i6 < i5; i6++) {
                        if ((255 & j2) < 128) {
                            int i7 = (i3 << 3) + i6;
                            if (((Boolean) predicate.invoke(objArr[i7], Long.valueOf(jArr[i7]))).booleanValue()) {
                                i4++;
                            }
                        }
                        j2 >>= 8;
    ...
    public static /* synthetic */ String joinToString$default(ObjectLongMap objectLongMap, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i2, CharSequence charSequence4, Function2 transform, int i3, Object obj) {
        long[] jArr;
        long[] jArr2;
        int i4;
        if (obj == null) {
                    ...
                    if ((((~j2) << 7) & j2 & (-9187201950435737472L)) != -9187201950435737472L) {
                        ...
                        while (i11 < i10) {
                            if ((j2 & 255) < 128) {
                                ...
                                jArr2 = jArr4;
                                sb.append((CharSequence) transform.invoke(obj2, Long.valueOf(j3)));
                                i7++;
                                i4 = 8;
                            } else {
                                jArr2 = jArr4;
                ...
                if ((((~j2) << 7) & j2 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i8 < i7) {
                        if ((j2 & 255) < 128) {
                            ...
                            sb.append((CharSequence) transform.invoke(obj, Long.valueOf(j3)));
                            i5++;
                            i3 = 8;
                        } else {
                            jArr2 = jArr4;

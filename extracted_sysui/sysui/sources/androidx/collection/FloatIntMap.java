...
public abstract class FloatIntMap {
    ...
    public static /* synthetic */ String joinToString$default(FloatIntMap floatIntMap, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i2, CharSequence charSequence4, int i3, Object obj) {
        if (obj != null) {
        ...
        return floatIntMap.joinToString(charSequence, charSequence5, charSequence6, i4, charSequence4);
    }
    ...
    */
        ...
        while (true) {
            ...
            if ((((~j2) << 7) & j2 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i4 = 0; i4 < i3; i4++) {
                    if ((255 & j2) < 128) {
                        int i5 = (i2 << 3) + i4;
                        block.invoke(Float.valueOf(fArr[i5]), Integer.valueOf(iArr[i5]));
                    }
                    j2 >>= 8;
                }
                if (i3 != 8) {
    ...
    public final int getOrDefault(float f2, int i2) {
        int iFindKeyIndex = findKeyIndex(f2);
        return iFindKeyIndex >= 0 ? this.values[iFindKeyIndex] : i2;
    }

    public final int getOrElse(float f2, Function0 defaultValue) {
                ...
                if ((((~j2) << 7) & j2 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i5 = 0; i5 < i4; i5++) {
                        if ((255 & j2) < 128) {
                            int i6 = (i3 << 3) + i5;
                            float f2 = fArr[i6];
                            iHashCode += Integer.hashCode(iArr[i6]) ^ Float.hashCode(f2);
                        }
                        j2 >>= 8;
                    }
                    if (i4 != 8) {
    ...
    */
            ...
            while (true) {
                ...
                if ((((~j2) << 7) & j2 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i6 = 0; i6 < i5; i6++) {
                        if ((255 & j2) < 128) {
                            int i7 = (i3 << 3) + i6;
                            if (((Boolean) predicate.invoke(Float.valueOf(fArr[i7]), Integer.valueOf(iArr[i7]))).booleanValue()) {
                                i4++;
                            }
                        }
                        j2 >>= 8;
    ...
    public static /* synthetic */ String joinToString$default(FloatIntMap floatIntMap, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i2, CharSequence charSequence4, Function2 transform, int i3, Object obj) {
        long[] jArr;
        long[] jArr2;
        int i4;
        if (obj == null) {
                    ...
                    if ((((~j2) << 7) & j2 & (-9187201950435737472L)) != -9187201950435737472L) {
                        ...
                        while (i11 < i10) {
                            if ((j2 & 255) < 128) {
                                ...
                                jArr2 = jArr3;
                                sb.append((CharSequence) transform.invoke(fValueOf, Integer.valueOf(i13)));
                                i7++;
                                i4 = 8;
                            } else {
                                jArr2 = jArr3;
                ...
                if ((((~j2) << 7) & j2 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i7 < i6) {
                        if ((j2 & 255) < 128) {
                            ...
                            jArr2 = jArr3;
                            sb.append((CharSequence) transform.invoke(Float.valueOf(f2), Integer.valueOf(i9)));
                            i4++;
                        } else {
                            jArr2 = jArr3;
                        }

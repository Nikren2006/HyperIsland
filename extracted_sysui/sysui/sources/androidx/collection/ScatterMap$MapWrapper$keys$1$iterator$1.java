...
@f(c = "androidx.collection.ScatterMap$MapWrapper$keys$1$iterator$1", f = "ScatterMap.kt", l = {726}, m = "invokeSuspend")
public final class ScatterMap$MapWrapper$keys$1$iterator$1 extends k implements Function2 {
    int I$0;
    int I$1;
    int I$2;
    int I$3;
    ...
    public ScatterMap$MapWrapper$keys$1$iterator$1(ScatterMap<K, V> scatterMap, d dVar) {
        super(2, dVar);
    ...
    public final Object invoke(AbstractC0342g abstractC0342g, d dVar) {
        return ((ScatterMap$MapWrapper$keys$1$iterator$1) create(abstractC0342g, dVar)).invokeSuspend(s.f314a);
    }

...
public abstract class IntSet {
    ...
    public static /* synthetic */ String joinToString$default(IntSet intSet, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i2, CharSequence charSequence4, int i3, Object obj) {
        ...
        return intSet.joinToString(charSequence, charSequence5, charSequence6, i4, charSequence4);
    }
        ...
        while (true) {
            ...
            if ((((~j2) << 7) & j2 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i4 = 0; i4 < i3; i4++) {
                    if ((255 & j2) < 128 && !((Boolean) predicate.invoke(Integer.valueOf(iArr[(i2 << 3) + i4]))).booleanValue()) {
                        return false;
                    }
                    j2 >>= 8;
                }
    ...
    */
    public boolean equals(java.lang.Object r15) {
        /*
            ...
            return r0
        L4:
            boolean r1 = r15 instanceof androidx.collection.IntSet
            r2 = 0
            if (r1 != 0) goto La
            return r2
        La:
            androidx.collection.IntSet r15 = (androidx.collection.IntSet) r15
            int r1 = r15._size
            int r3 = r14._size
            if (r1 == r3) goto L13
            return r2
            ...
            while (true) {
                ...
                if ((((~j2) << 7) & j2 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i6 = 0; i6 < i5; i6++) {
                        if ((255 & j2) < 128 && ((Boolean) predicate.invoke(Integer.valueOf(iArr[(i3 << 3) + i6]))).booleanValue()) {
                            i4++;
                        }
                        j2 >>= 8;
                    }
    ...
    */
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final int first(kotlin.jvm.functions.Function1 r14) {
        /*
            r13 = this;
            java.lang.String r0 = "predicate"
            kotlin.jvm.internal.n.g(r14, r0)
                ...
                if ((((~j2) << 7) & j2 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i7 = 0; i7 < i6; i7++) {
                        if ((j2 & 255) < 128) {
                            ...
                            sb.append((CharSequence) transform.invoke(Integer.valueOf(i8)));
                            i4++;
                            i5 = 8;
                        }
                        j2 >>= i5;

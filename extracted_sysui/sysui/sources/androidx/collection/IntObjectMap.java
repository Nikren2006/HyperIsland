...
public abstract class IntObjectMap<V> {
    ...
    public static /* synthetic */ String joinToString$default(IntObjectMap intObjectMap, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i2, CharSequence charSequence4, int i3, Object obj) {
        ...
        return intObjectMap.joinToString(charSequence, charSequence5, charSequence6, i4, charSequence4);
    }
        ...
        while (true) {
            ...
            if ((((~j2) << 7) & j2 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i4 = 0; i4 < i3; i4++) {
                    if ((255 & j2) < 128) {
                        int i5 = (i2 << 3) + i4;
                        if (!((Boolean) predicate.invoke(Integer.valueOf(iArr[i5]), objArr[i5])).booleanValue()) {
                            return false;
                        }
                    }
                    j2 >>= 8;
    ...
    */
    ...
    public final V getOrElse(int i2, Function0 defaultValue) {
    ...
    */
            ...
            while (true) {
                ...
                if ((((~j2) << 7) & j2 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i6 = 0; i6 < i5; i6++) {
                        if ((255 & j2) < 128) {
                            int i7 = (i3 << 3) + i6;
                            if (((Boolean) predicate.invoke(Integer.valueOf(iArr[i7]), objArr[i7])).booleanValue()) {
                                i4++;
                            }
                        }
                        j2 >>= 8;
    ...
    public static /* synthetic */ String joinToString$default(IntObjectMap intObjectMap, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i2, CharSequence charSequence4, Function2 transform, int i3, Object obj) {
        long[] jArr;
        long[] jArr2;
        int i4;
        if (obj == null) {
                    ...
                    if ((((~j2) << 7) & j2 & (-9187201950435737472L)) != -9187201950435737472L) {
                        ...
                        while (i11 < i10) {
                            if ((j2 & 255) < 128) {
                                ...
                                jArr2 = jArr3;
                                sb.append((CharSequence) transform.invoke(Integer.valueOf(i13), obj2));
                                i7++;
                                i4 = 8;
                            } else {
                                jArr2 = jArr3;
                ...
                if ((((~j2) << 7) & j2 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i8 < i7) {
                        if ((j2 & 255) < 128) {
                            ...
                            sb.append((CharSequence) transform.invoke(Integer.valueOf(i10), obj));
                            i5++;
                            i3 = 8;
                        } else {
                            jArr2 = jArr3;

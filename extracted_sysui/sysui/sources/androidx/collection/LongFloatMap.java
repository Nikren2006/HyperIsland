...
public abstract class LongFloatMap {
    ...
    public static /* synthetic */ String joinToString$default(LongFloatMap longFloatMap, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i2, CharSequence charSequence4, int i3, Object obj) {
        ...
        return longFloatMap.joinToString(charSequence, charSequence5, charSequence6, i4, charSequence4);
    }
        ...
        while (true) {
            ...
            if ((((~j2) << 7) & j2 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i4 = 0; i4 < i3; i4++) {
                    if ((255 & j2) < 128) {
                        int i5 = (i2 << 3) + i4;
                        if (!((Boolean) predicate.invoke(Long.valueOf(jArr[i5]), Float.valueOf(fArr[i5]))).booleanValue()) {
                            return false;
                        }
                    }
                    j2 >>= 8;
    ...
    */
    ...
    public final float getOrElse(long j2, Function0 defaultValue) {
                ...
                if ((((~j2) << 7) & j2 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i5 = 0; i5 < i4; i5++) {
                        if ((255 & j2) < 128) {
                            int i6 = (i3 << 3) + i5;
                            long j3 = jArr[i6];
                            iHashCode += Float.hashCode(fArr[i6]) ^ Long.hashCode(j3);
                        }
                        j2 >>= 8;
                    }
                    if (i4 != 8) {
                ...
                if ((((~j2) << 7) & j2 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i7 < i6) {
                        if ((j2 & 255) < 128) {
                            ...
                            jArr2 = jArr4;
                            sb.append((CharSequence) transform.invoke(Long.valueOf(j3), Float.valueOf(f2)));
                            i4++;
                        } else {
                            jArr2 = jArr4;
                        }

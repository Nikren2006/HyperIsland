...
public final class MutableLongLongMap extends LongLongMap {
    ...
    private final void resizeStorage(int i2) {
        ...
        while (i4 < i3) {
            if (((jArr3[i4 >> 3] >> ((i4 & 7) << 3)) & 255) < 128) {
                ...
                jArr = jArr3;
                jArr2 = jArr4;
                jArr8[i6] = (jArr8[i6] & (~(255 << i7))) | (j3 << i7);
                int i8 = this._capacity;
                int i9 = ((iFindFirstAvailableSlot - 7) & i8) + (i8 & 7);
                int i10 = i9 >> 3;
                int i11 = (i9 & 7) << 3;
                jArr8[i10] = (jArr8[i10] & (~(255 << i11))) | (j3 << i11);
                jArr6[iFindFirstAvailableSlot] = j2;
                jArr7[iFindFirstAvailableSlot] = jArr5[i4];
            } else {
                jArr = jArr3;
                jArr2 = jArr4;
            }
    ...
    public final long getOrPut(long j2, Function0 defaultValue) {
        ...
        while (true) {
            ...
            if ((((~j2) << 7) & j2 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i4 = 0; i4 < i3; i4++) {
                    if ((255 & j2) < 128) {
                        int i5 = (i2 << 3) + i4;
                        if (((Boolean) predicate.invoke(Long.valueOf(this.keys[i5]), Long.valueOf(this.values[i5]))).booleanValue()) {
                            removeValueAt(i5);
                        }
                    }
                    j2 >>= 8;

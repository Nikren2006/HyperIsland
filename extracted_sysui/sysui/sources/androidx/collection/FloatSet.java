...
public abstract class FloatSet {
    ...
    public static /* synthetic */ String joinToString$default(FloatSet floatSet, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i2, CharSequence charSequence4, int i3, Object obj) {
        ...
        return floatSet.joinToString(charSequence, charSequence5, charSequence6, i4, charSequence4);
    }
        ...
        while (true) {
            ...
            if ((((~j2) << 7) & j2 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i4 = 0; i4 < i3; i4++) {
                    if ((255 & j2) < 128 && !((Boolean) predicate.invoke(Float.valueOf(fArr[(i2 << 3) + i4]))).booleanValue()) {
                        return false;
                    }
                    j2 >>= 8;
                }
            ...
            while (true) {
                ...
                if ((((~j2) << 7) & j2 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i6 = 0; i6 < i5; i6++) {
                        if ((255 & j2) < 128 && ((Boolean) predicate.invoke(Float.valueOf(fArr[(i3 << 3) + i6]))).booleanValue()) {
                            i4++;
                        }
                        j2 >>= 8;
                    }
    ...
    */
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final float first(kotlin.jvm.functions.Function1 r14) {
        /*
            r13 = this;
            java.lang.String r0 = "predicate"
            kotlin.jvm.internal.n.g(r14, r0)

...
public abstract class IntLongMap {
    ...
    */
    ...
    public final long getOrElse(int i2, Function0 defaultValue) {
    ...
    */
    ...
    public static /* synthetic */ String joinToString$default(IntLongMap intLongMap, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i2, CharSequence charSequence4, Function2 transform, int i3, Object obj) {
        long[] jArr;
        long[] jArr2;
        int i4;
        if (obj == null) {
                    ...
                    if ((((~j2) << 7) & j2 & (-9187201950435737472L)) != -9187201950435737472L) {
                        ...
                        while (i11 < i10) {
                            if ((j2 & 255) < 128) {
                                ...
                                jArr2 = jArr4;
                                sb.append((CharSequence) transform.invoke(Integer.valueOf(i13), Long.valueOf(j3)));
                                i7++;
                                i4 = 8;
                            } else {
                                jArr2 = jArr4;
                ...
                if ((((~j2) << 7) & j2 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i7 < i6) {
                        if ((j2 & 255) < 128) {
                            ...
                            jArr2 = jArr4;
                            sb.append((CharSequence) transform.invoke(Integer.valueOf(i9), Long.valueOf(j3)));
                            i4++;
                        } else {
                            jArr2 = jArr4;
                        }
                ...
                if ((((~j2) << 7) & j2 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i8 < i7) {
                        if ((j2 & 255) < 128) {
                            ...
                            jArr2 = jArr4;
                            sb.append((CharSequence) transform.invoke(Integer.valueOf(i10), Long.valueOf(j3)));
                            i5++;
                            i3 = 8;
                        } else {
                            jArr2 = jArr4;

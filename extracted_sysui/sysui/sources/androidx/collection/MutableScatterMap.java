...
public final class MutableScatterMap<K, V> extends ScatterMap<K, V> {
    ...
    public final void clear() {
        ...
        AbstractC0180h.o(this.values, null, 0, this._capacity);
        AbstractC0180h.o(this.keys, null, 0, this._capacity);
        initializeGrowth();
    }

    public final V compute(K k2, Function2 computeBlock) {
        n.g(computeBlock, "computeBlock");
    ...
    public final V getOrPut(K k2, Function0 defaultValue) {
    ...
    */
    ...
    public final void plusAssign(InterfaceC0340e pairs) {
        n.g(pairs, "pairs");
        putAll(pairs);
    }
    ...
    /* JADX WARN: Multi-variable type inference failed */
    public final void putAll(InterfaceC0340e pairs) {
        n.g(pairs, "pairs");
    ...
    /* JADX WARN: Multi-variable type inference failed */
    public final void minusAssign(InterfaceC0340e keys) {
        n.g(keys, "keys");
    ...
    */
    public final boolean remove(K r18, V r19) {
        ...
        L70:
            ...
            r1 = r1[r11]
            r7 = r19
            boolean r1 = kotlin.jvm.internal.n.c(r1, r7)
            if (r1 == 0) goto L82

...
@f(c = "androidx.collection.ScatterSet$SetWrapper$iterator$1", f = "ScatterSet.kt", l = {495}, m = "invokeSuspend")
public final class ScatterSet$SetWrapper$iterator$1 extends k implements Function2 {
    int I$0;
    int I$1;
    int I$2;
    int I$3;
    ...
    public ScatterSet$SetWrapper$iterator$1(ScatterSet<E> scatterSet, d dVar) {
        super(2, dVar);
    ...
    public final Object invoke(AbstractC0342g abstractC0342g, d dVar) {
        return ((ScatterSet$SetWrapper$iterator$1) create(abstractC0342g, dVar)).invokeSuspend(s.f314a);
    }

...
public class Utils {
    ...
    public static class Point {
        ...
        public double f2562x;

        /* JADX INFO: renamed from: y, reason: collision with root package name */
        public double f2563y;
        ...
        public void Offset(Point point) {
            this.f2562x += point.f2562x;
            this.f2563y += point.f2563y;
        }

        public Point minus(Point point) {
            return new Point(this.f2562x - point.f2562x, this.f2563y - point.f2563y);
        }
    }
    ...
    static {
        ...
        INTENT_BLACK_LIST.add(SystemVolumeController.ACTION_PACKAGE_REPLACED);
    ...
    public static double Dist(Point point, Point point2, boolean z2) {
        double d2 = point.f2562x - point2.f2562x;
        double d3 = point.f2563y - point2.f2563y;
        return z2 ? Math.sqrt((d2 * d2) + (d3 * d3)) : (d2 * d2) + (d3 * d3);
    }
    ...
    public static Point pointProjectionOnSegment(Point point, Point point2, Point point3, boolean z2) {
        ...
        double dDist = ((pointMinus.f2562x * pointMinus2.f2562x) + (pointMinus.f2563y * pointMinus2.f2563y)) / Dist(point, point2, false);
        ...
        pointMinus.f2562x *= dDist;
        pointMinus.f2563y *= dDist;
    ...
    /* JADX WARN: Removed duplicated region for block: B:13:0x0029 A[Catch: Exception -> 0x0027, TRY_LEAVE, TryCatch #0 {Exception -> 0x0027, blocks: (B:8:0x001b, B:10:0x001f, B:13:0x0029), top: B:18:0x001b }] */
    /*
    ...
    */
    public static void startActivity(android.content.Context r3, android.content.Intent r4, android.os.Bundle r5) {
        ...
        L19:
            if (r0 == 0) goto L29
            int r0 = com.miui.maml.util.Utils.sAcrossUsersFullPermission     // Catch: java.lang.Exception -> L27
            if (r0 != 0) goto L29
            android.os.UserHandle r0 = com.miui.maml.util.HideSdkDependencyUtils.UserHandle_CURRENT()     // Catch: java.lang.Exception -> L27
            com.miui.maml.util.HideSdkDependencyUtils.Context_startActivityAsUser(r3, r4, r5, r0)     // Catch: java.lang.Exception -> L27
            goto L43
        L27:
            r3 = move-exception
            goto L2d
        L29:
            r3.startActivity(r4, r5)     // Catch: java.lang.Exception -> L27
            goto L43
        L2d:
            ...
            com.miui.maml.util.MamlLog.i(r4, r3)
        L43:
            return
        */
    ...
    public static void startActivityBg(final Context context, final Intent intent, final Bundle bundle) {
        if (Looper.getMainLooper() != Looper.myLooper()) {
            new Handler(Looper.getMainLooper()).post(new Runnable() { // from class: com.miui.maml.util.f
    ...
    public static void triggerGC() {
        Log.w("mamlview", "triggerGC start");
        Runtime.getRuntime().gc();
        Runtime.getRuntime().runFinalization();
        Log.w("mamlview", "triggerGC end");
    }

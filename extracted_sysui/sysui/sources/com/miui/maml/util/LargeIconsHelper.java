...
public class LargeIconsHelper {
    ...
    static {
        ...
        arrayList.add("2x1");
        arrayList.add("2x2");
        mOnCreateRootCallback = new RendererCoreCache.OnCreateRootCallback() { // from class: com.miui.maml.util.d
    ...
    private static LargeIconConfigFile generateLargeIconConfigFile(String str) {
        ...
        sb.append(myUserId());
        sb.append(str2);
        sb.append(LARGE_ICONS_APP_FOLD);
        sb.append(str2);
        sb.append(str);
        sb.append(str2);
    ...
    private static Drawable getFancyDrawable(LargeIconConfigFile.Icon icon, String str, Context context, String str2, String str3, long j2, UserHandle userHandle) {
        ...
        if (rendererCoreInfo == null || rendererCoreInfo.f2561r == null) {
            return null;
        }
        return new FancyDrawable(rendererCoreInfo.f2561r);
    }
    ...
    private static boolean getUseFancyWhenStaticFromConfig(ConfigFile configFile, int i2) {
        ...
        boolean zEquals = TextUtils.equals(com.xiaomi.onetrack.util.a.f3424i, configFile.getVariable("use_fancy_when_static_layer" + i2));
        if (zEquals) {
            return zEquals;
        }
        return TextUtils.equals(com.xiaomi.onetrack.util.a.f3424i, configFile.getVariable("layer_only_fancy" + i2));
    }
    ...
    private static boolean getUseQuietWhenAnimFromConfig(ConfigFile configFile, int i2) {
        ...
        boolean zEquals = TextUtils.equals(com.xiaomi.onetrack.util.a.f3424i, configFile.getVariable("use_quiet_when_anim_layer" + i2));
        if (zEquals) {
            return zEquals;
        }
        return TextUtils.equals(com.xiaomi.onetrack.util.a.f3424i, configFile.getVariable("layer_only_quiet" + i2));
    }
    ...
    public static boolean isXSpaceUserId(UserHandle userHandle) {
        try {
            ...
            MamlLog.e(TAG, "Invoke | XSpaceUserHandle isXSpaceUser() occur EXCEPTION: ", e2);
            return false;
        }
    }
                ...
                case "res":
                    ...
                    if (!z2) {
                        if (transFormConfig == 1 && resDrawable != null) {
                            if (PortableUtils.cutBlankIcon(strCalculateIconSize)) {
                                float scaleRatio = BitmapUtils.getScaleRatio(resDrawable);
                                if (scaleRatio > 1.0f) {
                                    bitmapDrawableToBitmap = BitmapUtils.drawableToBitmapWithoutBlank(resDrawable, scaleRatio, false);
                                } else {
                                    bitmapDrawableToBitmap = BitmapUtils.drawableToBitmap(resDrawable);
                                }
                            } else {
                                bitmapDrawableToBitmap = BitmapUtils.drawableToBitmap(resDrawable);
                            }

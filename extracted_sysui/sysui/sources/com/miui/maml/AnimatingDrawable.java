...
public class AnimatingDrawable extends MamlDrawable {
    ...
    private void init() {
        ...
        if (drawable == null) {
            MamlLog.i(TAG, "mQuietDrwable is null! package/class=" + this.mPackageName + "/" + this.mClassName);
            return;
        }
    ...
    public AnimatingDrawable(Context context, String str, String str2, ResourceManager resourceManager, UserHandle userHandle, int i2, int i3, boolean z2, boolean z3, boolean z4, LargeIconConfigFile.Icon icon, String str3) {

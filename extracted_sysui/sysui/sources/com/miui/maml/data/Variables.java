...
public class Variables {
    ...
    public static abstract class BaseVarBucket {
        ...
        public abstract void onAddItem(int i2);
        ...
        public synchronized int registerVariable(String str) {
            ...
            try {
                ...
                MamlLog.d(Variables.LOG_TAG, "registerVariable: " + str + "  index:" + numValueOf);
            } catch (Throwable th) {
                throw th;
            }
    ...
    public boolean createArray(String str, int i2, Class<?> cls) {
        ...
        MamlLog.w(LOG_TAG, "createArray failed: name= " + str + "  size=" + i2);
        return false;
    }

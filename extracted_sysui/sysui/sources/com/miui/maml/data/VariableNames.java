...
public class VariableNames {
    ...
    public static final String VAR_DEVICE_LEVEL = "__device_level";
    public static final String VAR_HOUR12 = "hour12";
    public static final String VAR_HOUR24 = "hour24";
    public static final String VAR_HYPER_OS_VERSION_CODE = "__hyper_os_version_code";
    public static final String VAR_HYPER_OS_VERSION_NAME = "__hyper_os_version_name";

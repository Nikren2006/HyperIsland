...
public class StringFunctions extends Expression.FunctionImpl {
    ...
    /* JADX INFO: renamed from: com.miui.maml.data.StringFunctions$1, reason: invalid class name */
                ...
                switch (iArr[this.mFun.ordinal()]) {
                    ...
                    case 4:
                        ...
                        try {
                            ...
                            MamlLog.w(LOG_TAG, "invaid pattern of matches: " + strEvaluateStr2);
                            return 0.0d;
                        }
                    case 5:
                        if (strEvaluateStr == null || strEvaluateStr2 == null) {
                    ...
                    default:
                        MamlLog.e(LOG_TAG, "fail to evalute FunctionExpression, invalid function: " + this.mFun.toString());
                        return 0.0d;
                }
        }
    }
                                ...
                                switch (iArr[this.mFun.ordinal()]) {
                                    ...
                                    case 9:
                                        try {
                                            ...
                                            MamlLog.e(LOG_TAG, "invaid pattern of replaceAll: " + strEvaluateStr2, e2);
                                    ...
                                    case 10:
                                        try {
                                            ...
                                            MamlLog.e(LOG_TAG, "invaid pattern of replaceFirst:" + strEvaluateStr2, e3);
                                            return strEvaluateStr;
                                        }
                                        break;
                                    default:
                                        MamlLog.e(LOG_TAG, "fail to evaluteStr FunctionExpression, invalid function: " + this.mFun.toString());
                                        break;
                                }
                            }
                            break;

...
public class BaseFunctions extends Expression.FunctionImpl {
    ...
    /* JADX INFO: renamed from: com.miui.maml.data.BaseFunctions$1, reason: invalid class name */
    ...
    public static void load() {
        ...
        Expression.FunctionExpression.registerFunction(com.xiaomi.onetrack.g.a.f3352e, new BaseFunctions(Fun.HASH, 2));
    ...
    @Override // com.miui.maml.data.Expression.FunctionImpl
    public String evaluateStr(Expression[] expressionArr, Variables variables) {
        int i2 = AnonymousClass1.$SwitchMap$com$miui$maml$data$BaseFunctions$Fun[this.fun.ordinal()];
        int i3 = 0;
        if (i2 == 13) {
            String strEvaluateStr = expressionArr[0].evaluateStr();
            if (strEvaluateStr == null) {

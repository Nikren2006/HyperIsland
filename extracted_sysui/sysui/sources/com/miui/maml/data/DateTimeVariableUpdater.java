...
public class DateTimeVariableUpdater extends NotifierVariableUpdater {
    ...
    /* JADX INFO: renamed from: com.miui.maml.data.DateTimeVariableUpdater$1, reason: invalid class name */
    ...
    private void updateTimeForResume() {
        long jCurrentTimeMillis = System.currentTimeMillis();
        this.mTimeSys.set(jCurrentTimeMillis);
        this.mCalendar.setTimeInMillis(jCurrentTimeMillis);
        int i2 = this.mCalendar.get(1);
    ...
    public void checkUpdateTime() {
        ...
        synchronized (this.mLock) {
            try {
                if (this.mFinished) {
                    MamlLog.w(LOG_TAG, "checkUpdateTime: finished");
                    return;
                }
                if (getRoot() == null) {
                    MamlLog.e(LOG_TAG, "checkUpdateTime: getRoot is null");
                    return;
                }
                ...
                boolean zIs24HourFormat = DateFormat.is24HourFormat(getContext().mContext);
                long timeInMillis = this.mCalendar.getTimeInMillis();
                if (this.mCurrentTime != timeInMillis || this.mTimeFormat != zIs24HourFormat) {
                    this.mCurrentTime = timeInMillis;
                    this.mNextUpdateTime = timeInMillis + this.mTimeAccuracy;
                    this.mTimeFormat = zIs24HourFormat ? 1 : 0;
                    this.mTimeFormatVar.set(zIs24HourFormat ? 1.0d : 0.0d);
    ...
    public DateTimeVariableUpdater(VariableUpdaterManager variableUpdaterManager, String str) {
        ...
        if (accuracy == null) {
            ...
            MamlLog.w(LOG_TAG, "invalid accuracy tag:" + str);
        }
        initInner(accuracy);
    }

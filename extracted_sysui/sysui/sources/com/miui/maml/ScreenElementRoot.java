...
public class ScreenElementRoot extends ScreenElement implements InteractiveListener {
    ...
    private static final String HYPER_OS_VERSION_CODE = "ro.mi.os.version.code";
    private static final String HYPER_OS_VERSION_NAME = "ro.mi.os.version.name";
    private static final String LOG_TAG = "ScreenElementRoot";
    private static final int MAML_INTERNAL_VERSION = Integer.parseInt(BuildConfig.mamlVersionCode);
    ...
    private boolean isIconLoad;
    private boolean isUnlockedReceiverRegistered;
    ...
    private MamlView.Config mMamlViewConfig;
    ...
    private boolean mSupportBackgroundBlur;
    ...
    private UnlockedReceiver mUserUnlockedReceiver;
    ...
    /* JADX INFO: renamed from: com.miui.maml.ScreenElementRoot$4, reason: invalid class name */
    ...
    public static class ExtraResource {
        ...
        public ExtraResource(Element element, int i2) {
            ...
            resource.mScreenWidth = (ResourceManager.translateDensity(i2) * 480) / ScreenElementRoot.DEFAULT_RES_DENSITY;
            ...
            scaleMetrics.mScreenWidth = (ResourceManager.translateDensity(i2) * 480) / ScreenElementRoot.DEFAULT_RES_DENSITY;
        ...
        private void inflateMetrics(ArrayList<ScaleMetrics> arrayList, String str, MetricsType metricsType) {
            ...
            for (String str2 : str.split(aa.f3429b)) {
                try {
                    ...
                    MamlLog.w(ScreenElementRoot.LOG_TAG, "format error of attribute: " + str);
                }
            }
        }
        ...
        public static int parseSizeType(String str) {
            ...
            if (DynamicIslandEventsConstants.Values.VALUE_CHANNEL_TYPE_NORMAL.equals(str)) {
                return 2;
            }
            if ("large".equals(str)) {
                return 3;
        ...
        public ScaleMetrics findMetrics(int i2, int i3, int i4, ArrayList<ScaleMetrics> arrayList) {
            ...
            public ScaleMetrics(String str, MetricsType metricsType) {
                ...
                try {
                    ...
                    if (i2 == 1) {
                        ...
                        this.mDensity = i3;
                        this.mScreenWidth = (ResourceManager.translateDensity(i3) * 480) / ScreenElementRoot.DEFAULT_RES_DENSITY;
                    ...
                    if (i2 == 2) {
                        ...
                        this.mDensity = ResourceManager.retranslateDensity((i4 * ScreenElementRoot.DEFAULT_RES_DENSITY) / 480);
                        if (strArrSplit.length > 1) {
                            this.scale = Float.parseFloat(strArrSplit[1]);
                            return;
                        }
                    ...
                    if (strArrSplit2.length == 1) {
                        if (strArrSplit2[0].startsWith("sw")) {
                            ...
                            this.mDensity = ResourceManager.retranslateDensity((i5 * ScreenElementRoot.DEFAULT_RES_DENSITY) / 480);
                        } else if (strArrSplit2[0].startsWith("den")) {
                            int i6 = Integer.parseInt(strArrSplit2[0].substring(3));
                            this.mDensity = i6;
                            this.mScreenWidth = (ResourceManager.translateDensity(i6) * 480) / ScreenElementRoot.DEFAULT_RES_DENSITY;
                        } else {
                    ...
                    MamlLog.w(ScreenElementRoot.LOG_TAG, "format error of string: " + str);
    ...
    public static class InnerGroup extends ElementGroup {
    ...
    public static class UnlockedReceiver extends BroadcastReceiver {
        private WeakReference<VariableBinderManager> mVariableBinderManagerRef;

        public UnlockedReceiver(VariableBinderManager variableBinderManager) {
            this.mVariableBinderManagerRef = new WeakReference<>(variableBinderManager);
        }

        @Override // android.content.BroadcastReceiver
        public void onReceive(Context context, Intent intent) {
            if ("android.intent.action.USER_UNLOCKED".equals(intent.getAction())) {
                VariableBinderManager variableBinderManager = this.mVariableBinderManagerRef.get();
                if (variableBinderManager != null) {
                    variableBinderManager.binderStartQuery();
                }
                MamlLog.w(ScreenElementRoot.LOG_TAG, "user unlocked, start query");
            }
        }
    }

    public ScreenElementRoot(@NonNull ScreenContext screenContext) {
        super(null, null);
        ...
        this.mSupportBackgroundBlur = false;
        ...
        this.isUnlockedReceiverRegistered = false;
        this.mRoot = this;
    ...
    private void processUseVariableUpdater(Element element) {
        ...
        if (this.isUnlockedReceiverRegistered) {
            return;
        }
        UnlockedReceiver unlockedReceiver = new UnlockedReceiver(this.mVariableBinderManager);
        this.mUserUnlockedReceiver = unlockedReceiver;
        this.mContext.mContext.registerReceiver(unlockedReceiver, new IntentFilter("android.intent.action.USER_UNLOCKED"), 4);
        this.isUnlockedReceiverRegistered = true;
    }
    ...
    private void setupScale(Element element) {
        ...
        if (i2 == 0 && iTranslateDensity == 0) {
            ...
            this.mDefaultResourceDensity = (i2 * DEFAULT_RES_DENSITY) / 480;
        } else if (i2 == 0) {
            this.mDefaultScreenWidth = (iTranslateDensity * 480) / DEFAULT_RES_DENSITY;
        }
        ...
        MamlView.Config config = this.mMamlViewConfig;
        if (config == null || config.flags != 1) {
            ...
            this.mTargetScreenWidth = targetScreenWH[0];
            this.mTargetScreenHeight = targetScreenWH[1];
        }
        ...
        if (i4 == 0) {
            i4 = (this.mDefaultScreenWidth * DEFAULT_RES_DENSITY) / 480;
        }
        ...
        MamlLog.d(LOG_TAG, "findResource: " + resourceFindResource.toString());
        ...
        MamlLog.d(LOG_TAG, "findScale: " + scaleMetricsFindScale.toString());
        if (this.mScaleByDensity) {
            ...
            float f2 = this.mResizeScale;
            if (f2 > 0.0f) {
                this.mTargetDensity = (int) (iTranslateDensity2 * f2);
            }
            float f3 = scaleMetricsFindScale.scale;
            if (f3 <= 0.0f) {
                this.mScale = this.mTargetDensity / this.mDefaultResourceDensity;
            } else {
                float f4 = f3 * ((this.mRawTargetDensity * 1.0f) / scaleMetricsFindScale.mDensity);
                this.mScale = f4;
                if (f2 > 0.0f) {
                    this.mScale = f4 * f2;
                }
            ...
            float f5 = i5 / this.mDefaultScreenWidth;
            this.mScale = f5;
            this.mTargetDensity = (int) (this.mDefaultResourceDensity * f5);
            float f6 = scaleMetricsFindScale.scale;
            if (f6 > 0.0f) {
                this.mScale = f6 * ((i5 * 1.0f) / scaleMetricsFindScale.mScreenWidth);
            }
        }
        MamlLog.w(LOG_TAG, "set scale: " + this.mScale);
    ...
    public void clearMamlAccessHelper() {
        if (this.mMamlAccessHelper != null) {
    ...
    public void doRender(Canvas canvas) {
        ...
        try {
            ...
            MamlLog.e(LOG_TAG, e3.toString(), e3);
        }
    ...
    public void finish() {
        ...
        if (this.isUnlockedReceiverRegistered) {
            try {
                UnlockedReceiver unlockedReceiver = this.mUserUnlockedReceiver;
                if (unlockedReceiver != null) {
                    this.mContext.mContext.unregisterReceiver(unlockedReceiver);
                }
                this.isUnlockedReceiverRegistered = false;
            } catch (IllegalArgumentException e2) {
                MamlLog.w(LOG_TAG, "unregister UserUnlockedReceiver failed," + e2.getMessage());
            }
        }
        VariableBinderManager variableBinderManager = this.mVariableBinderManager;
        if (variableBinderManager != null) {
    ...
    public final float getScale() {
        ...
        MamlLog.w(LOG_TAG, "scale not initialized!");
        return 1.0f;
    }
    ...
    public void init() {
        ...
        if (this.mLoaded) {
            ...
            MamlView.Config config = this.mMamlViewConfig;
            if (config == null || (i2 = config.viewWidth) <= 0 || config.viewHeight <= 0) {
                ...
                if (i4 > 0) {
                    variables.put("view_width", i4);
                }
                int i5 = this.mRawHeight;
                if (i5 > 0) {
                    variables.put("view_height", i5);
                }
            } else {
                variables.put("view_width", i2 / this.mScale);
                variables.put("view_height", this.mMamlViewConfig.viewHeight / this.mScale);
            }
            variables.put(RAW_DENSITY, this.mRawTargetDensity);
            variables.put(SCALE_FACTOR, this.mScale);
            variables.put(VAR_MAML_VERSION, MAML_INTERNAL_VERSION);
            try {
                ...
                MamlLog.e(LOG_TAG, "thememanager not found");
            }
            variables.put(VariableNames.VAR_THEMEMANAGER_VERSION, i3);
            ...
            variables.put(VariableNames.VAR_DEVICE_LEVEL, DeviceUtils.getDeviceLevel());
            variables.put(VariableNames.VAR_HYPER_OS_VERSION_NAME, SystemProperties.get(HYPER_OS_VERSION_NAME));
            variables.put(VariableNames.VAR_HYPER_OS_VERSION_CODE, SystemProperties.get(HYPER_OS_VERSION_CODE));
            loadConfig();
            VariableUpdaterManager variableUpdaterManager = this.mVariableUpdaterManager;
            if (variableUpdaterManager != null) {
    ...
    public void issueExternCommand(String str, Double d2, String str2) {
        ...
        if (weakReference != null && (onExternCommandListener3 = weakReference.get()) != null) {
            ...
            MamlLog.d(LOG_TAG, "issueExternCommand: " + str + " " + d2 + " " + str2);
        }
        ...
        if (weakReference2 != null && (onExternCommandListener2 = weakReference2.get()) != null) {
            ...
            MamlLog.d(LOG_TAG, "issueExternCommand to MamlView: " + str + " " + d2 + " " + str2);
        }
        ...
        MamlLog.d(LOG_TAG, "issueExternCommand to MamlSurface: " + str + " " + d2 + " " + str2);
    }
    ...
    public final boolean load() {
        try {
            ...
            if (manifestRoot == null) {
                MamlLog.e(LOG_TAG, "load error, manifest root is null");
                return false;
            }
            ...
            this.mSupportBackgroundBlur = Boolean.parseBoolean(manifestRoot.getAttribute("supportBackgroundBlur"));
            ...
            if (innerGroup.getElements().size() <= 0) {
                MamlLog.e(LOG_TAG, "load error, no element loaded");
                return false;
            }
            this.mVersion = Utils.getAttrAsInt(manifestRoot, "version", 1);
            if (!onLoad(manifestRoot)) {
                MamlLog.e(LOG_TAG, "load error, onLoad fail");
                return false;
            }
            traverseElements();
            MamlLog.d(LOG_TAG, "load finished, spent " + (SystemClock.elapsedRealtime() - jElapsedRealtime) + " ms");
            this.mLoaded = true;
            return true;
        } catch (Exception e2) {
            MamlLog.e(LOG_TAG, "load error! ", e2);
            return false;
        }
    }
            ...
            postRunnable(new Runnable() { // from class: com.miui.maml.ScreenElementRoot.3
                ...
                public void run() {
                    try {
                        ...
                        MamlLog.e(ScreenElementRoot.LOG_TAG, e2.toString());
                        e2.printStackTrace();
                    }
                }
            });
    ...
    public void onConfigurationChanged(Configuration configuration) {
        ...
        if (elementGroup != null) {
            elementGroup.onConfigurationChanged(configuration);
        }
    ...
    public boolean onHover(MotionEvent motionEvent) {
        try {
            ...
            MamlLog.e(LOG_TAG, e2.toString(), e2);
            return false;
        }
    }
    ...
    public void pause() {
        if (this.mLoaded) {
            ...
            this.mInnerGroup.performAction(MiPlayEventsKt.POSITION_PAUSE);
    ...
    public void saveVar(String str, Double d2) {
        ConfigFile configFile = this.mConfig;
        if (configFile == null) {
            MamlLog.w(LOG_TAG, "fail to saveVar, config file is null");
        } else if (d2 == null) {
    ...
    public void setConfiguration(Configuration configuration, boolean z2) {
        if (this.mAllowScreenRotation || z2) {
            Variables variables = this.mContext.mVariables;
    ...
    public void setIconLoad(boolean z2) {
        this.isIconLoad = z2;
    }
    ...
    public void setMamlViewConfig(MamlView.Config config) {
        this.mMamlViewConfig = config;
    }
    ...
    public boolean supportBackgroundBlur() {
        return this.mSupportBackgroundBlur;
    }
                ...
                public void run() {
                    ...
                    if (ScreenElementRoot.this.mExternalCommandManager != null) {
                        try {
                            ...
                            MamlLog.w(ScreenElementRoot.LOG_TAG, "onAction init fail." + e2);
                        }
                    }
                }
            });
    ...
    public void updateDateTimeVariable(String str) {
        if (TextUtils.isEmpty(str) && this.mVariableUpdaterManager == null) {
            return;
        }
        this.mVariableUpdaterManager.updateDateTimeVariable(str);
    ...
    private void loadConfig(String str) {
        ...
        for (ConfigFile.Variable variable : this.mConfig.getVariables()) {
            if (TextUtils.equals(variable.type, TypedValues.Custom.S_STRING)) {

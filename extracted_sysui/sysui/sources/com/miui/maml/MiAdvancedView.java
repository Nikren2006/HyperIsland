...
public class MiAdvancedView extends View implements RendererController.IRenderable {
    ...
    public void init() {
        ...
        this.mRoot.setConfiguration(getResources().getConfiguration(), false);
    ...
    public void onDraw(Canvas canvas) {
        if (!this.mLoggedHardwareRender) {
            MamlLog.d(LOG_TAG, "canvas hardware render: " + canvas.isHardwareAccelerated());
    ...
    public void cleanUp(boolean z2) {
        ...
        Log.w(LOG_TAG, "cleanUp: triggerGC");
        Executors.newSingleThreadExecutor().execute(new Runnable() { // from class: com.miui.maml.c

...
public abstract class BaseVideoView extends SurfaceView {
    ...
    public BaseVideoView(Context context) {
        ...
        this.mSHCallback = new SurfaceHolder.Callback() { // from class: com.miui.maml.elements.video.BaseVideoView.1
            ...
            public void surfaceChanged(SurfaceHolder surfaceHolder, int i2, int i3, int i4) {
                boolean z2 = false;
                boolean z3 = BaseVideoView.this.mTargetState == 3;
                BaseVideoView baseVideoView = BaseVideoView.this;
                if (baseVideoView.mVideoWidth == i3 && baseVideoView.mVideoHeight == i4) {
                    z2 = true;
                }
                if (baseVideoView.mMediaPlayer != null && z3 && z2) {
            ...
            public void surfaceCreated(SurfaceHolder surfaceHolder) {
                MamlLog.d(BaseVideoView.TAG, "surfaceCreated " + surfaceHolder);
        ...
        this.mInfoListener = new MediaPlayer.OnInfoListener() { // from class: com.miui.maml.elements.video.BaseVideoView.3
            ...
            public boolean onInfo(MediaPlayer mediaPlayer, int i2, int i3) {
                MamlLog.d(BaseVideoView.TAG, "onInfo: " + i2 + aa.f3429b + i3);
                return true;
            }
        };
        this.mErrorListener = new MediaPlayer.OnErrorListener() { // from class: com.miui.maml.elements.video.BaseVideoView.4
            ...
            public boolean onError(MediaPlayer mediaPlayer, int i2, int i3) {
                MamlLog.d(BaseVideoView.TAG, "Error: " + i2 + aa.f3429b + i3);
    ...
    public void openVideo() {
        ...
        try {
            ...
            MamlLog.e(TAG, "Unable to open content: " + this.mDataSource, e2);
    ...
    public abstract void addSurfaceHolderCallback();
    ...
    public void releaseMedia(boolean z2) {
    ...
    public abstract void setFormat(int i2);
    ...
    public abstract void updateVideoSize();
}

...
public abstract class ScreenElement {
    ...
    /* JADX INFO: renamed from: com.miui.maml.elements.ScreenElement$2, reason: invalid class name */
    ...
    private void load(Element element) {
        ...
        String attr = getAttr(element, au.f2921a);
        this.mName = attr;
        boolean zIsEmpty = TextUtils.isEmpty(attr);
        this.mHasName = !zIsEmpty;
        if (!zIsEmpty) {
        ...
        if (!TextUtils.isEmpty(attr3)) {
            ...
            } else if (attr3.equalsIgnoreCase(com.xiaomi.onetrack.util.a.f3424i)) {
                this.mInitShow = true;
            } else {
    ...
    public int getAttrAsInt(Element element, String str, int i2) {
        String attr = getAttr(element, str);
        if (!TextUtils.isEmpty(attr)) {
            try {
    ...
    public long getAttrAsLong(Element element, String str, long j2) {
        String attr = getAttr(element, str);
        if (!TextUtils.isEmpty(attr)) {
            try {
    ...
    public float getLeft(float f2, float f3) {
        ...
        int i2 = AnonymousClass2.$SwitchMap$com$miui$maml$elements$ScreenElement$Align[this.mAlign.ordinal()];
        if (i2 == 1) {
            f3 /= 2.0f;
        } else if (i2 != 2) {
            return f2;
    ...
    public float getTop(float f2, float f3) {
        ...
        int i2 = AnonymousClass2.$SwitchMap$com$miui$maml$elements$ScreenElement$AlignV[this.mAlignV.ordinal()];
        if (i2 == 1) {
            f3 /= 2.0f;
        } else if (i2 != 2) {
            return f2;
    ...
    public CommandTriggers getTriggers() {
    ...
    public void resume() {
        ...
        LanguageHelper.setPluralsVariables(getVariables(), getContext().mResourceManager);
    }
    ...
    public final void setAnimations(String str) {
        setAnim((TextUtils.isEmpty(str) || ".".equals(str)) ? null : str.split(aa.f3429b));
    }

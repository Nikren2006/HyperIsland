...
public class AnimConfigElement extends ConfigElement {
            ...
            for (int i2 = 0; i2 < length; i2++) {
                if (childNodes.item(i2).getNodeType() == 1) {
                    ...
                    if ("Special".equals(element2.getTagName())) {
                        String attribute = element2.getAttribute(au.f2921a);
    ...
    */
    private void updateConfigIndexVariable(com.miui.maml.elements.AnimConfigElement.ConfigData r7, java.lang.String r8, java.lang.String r9, @androidx.annotation.NonNull com.miui.maml.data.Expression[] r10) {
        /*
    ...
    public void evaluateConfigValue() {

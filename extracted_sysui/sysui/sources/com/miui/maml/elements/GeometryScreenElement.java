...
public abstract class GeometryScreenElement extends AnimatedScreenElement {
    ...
    static {
        ...
        Integer numValueOf = Integer.valueOf(AnimatedPropertyType.STROKE_COLOR);
        concurrentHashMap.put(numValueOf, animatedColorProperty2);
        AnimatedTarget.sPropertyTypeMap.put(animatedColorProperty2, numValueOf);

...
public class GraphicsElement extends AnimatedScreenElement {
    ...
    private GraphicsShader getGraphicsShader(int i2, int[] iArr, float[] fArr, String str, String str2, int i3) {
        ...
        if (zIsShaderParmsChanged && !resetShader(graphicsShader2, i2, iArr, fArr, str, tileMode)) {
            return null;
        }
        resetMatrixIfNecessary(zIsShaderParmsChanged, graphicsShader2, i2, str);
    ...
    private boolean isValid() {
        ...
        MamlLog.e(LOG_TAG, "Call maml graphics api not in onDraw callback");
        return false;
    }
    ...
    private boolean resetShader(GraphicsShader graphicsShader, int i2, int[] iArr, float[] fArr, String str, Shader.TileMode tileMode) {
        if (i2 == 1) {
            ...
            if (i2 != 2) {
                MamlLog.e(LOG_TAG, "wrong shader type " + i2);
                return false;
            }
    ...
    public void drawRoundRect(float f2, float f3, float f4, float f5, float f6, float f7) {
        ...
        if (strokeWidth > 0.0f) {
            ...
            if (fMin <= 0.0f) {
                this.mCanvas.drawRect(rectF, this.mStrokePaint);
            } else {
                this.mCanvas.drawRoundRect(rectF, fMin, fMin, this.mStrokePaint);
            }
        }
    }

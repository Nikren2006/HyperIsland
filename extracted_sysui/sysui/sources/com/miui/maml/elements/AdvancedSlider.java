...
public class AdvancedSlider extends ElementGroup {
    ...
    /* JADX INFO: renamed from: com.miui.maml.elements.AdvancedSlider$1, reason: invalid class name */
    ...
    public class EndPoint extends SliderPoint {
        ...
        private void loadTask(Element element) {
            ...
            if (this.mAction.mCommand == null) {
                MamlLog.w(AdvancedSlider.LOG_TAG, "invalid Command element: " + child2.toString());
            }
        }
    ...
    public class InterpolatorController extends ReboundAnimationController {
        ...
        public long getDistance(long j2) {
    ...
    public class SliderPoint extends ElementGroup {
        ...
        private void load(Element element, String str) {
            this.mName = getAttr(element, au.f2921a);
        ...
        public void onStateChange(State state, State state2) {
            ...
            if (i2 == 1) {
                ...
                performAction(DynamicIslandEventsConstants.Values.VALUE_CHANNEL_TYPE_NORMAL);
                return;
            }
            if (i2 != 2) {
                if (i2 != 3) {
        ...
        public void setState(State state) {
            ...
            this.mState = state;
            int i3 = AnonymousClass1.$SwitchMap$com$miui$maml$elements$AdvancedSlider$State[state.ordinal()];
            if (i3 == 1) {
                elementGroup = this.mNormalStateElements;
                z2 = this.mPressedStateElements != null;
                i2 = 0;
            } else if (i3 == 2) {
                ElementGroup elementGroup3 = this.mPressedStateElements;
                i2 = 1;
                ElementGroup elementGroup4 = elementGroup3 != null ? elementGroup3 : this.mNormalStateElements;
                z2 = (elementGroup3 == null || AdvancedSlider.this.mStartPointPressed) ? false : true;
                ...
                ElementGroup elementGroup5 = this.mReachedStateElements;
                if (elementGroup5 != null) {
                    elementGroup2 = elementGroup5;
                } else {
                    elementGroup2 = this.mPressedStateElements;
                    if (elementGroup2 == null) {
                        elementGroup2 = this.mNormalStateElements;
                    }
                }
                z2 = elementGroup5 != null;
                elementGroup = elementGroup2;
                i2 = 2;
            }
    ...
    public class SpeedAccController extends ReboundAnimationController implements ITicker {
        ...
        public long getDistance(long j2) {
            ...
            if (d2 > 0.0d) {
                ...
                if (indexedVariable2 != null) {
                    indexedVariable2.set(d3 <= 1.0d ? d3 : 1.0d);
                }
            }
            return j3;
        }
    ...
    public class StartPoint extends SliderPoint {
        ...
        public void onStateChange(State state, State state2) {
            ...
            int i2 = AnonymousClass1.$SwitchMap$com$miui$maml$elements$AdvancedSlider$State[state2.ordinal()];
            if (i2 == 1) {
    ...
    private boolean checkEndPoint(Utils.Point point, EndPoint endPoint) {
        if (!endPoint.touched((float) point.f2562x, (float) point.f2563y, false)) {
    ...
    private CheckTouchResult checkTouch(float f2, float f3) {
        ...
        if (f4 >= Float.MAX_VALUE) {
            MamlLog.i(LOG_TAG, "unlock touch canceled due to exceeding tollerance");
            this.mStartPoint.performAction(Const.Param.NOTIFICATION_CANCEL);
            return null;
        }
        moveStartPoint((float) point.f2562x, (float) point.f2563y);
        if (f4 < FREE_ENDPOINT_DIST) {
            ...
            boolean zCheckEndPoint2 = false;
            while (true) {
                if (!it.hasNext()) {
                    break;
                }
                EndPoint next = it.next();
                if (next.mPath == null && (zCheckEndPoint2 = checkEndPoint(point, next))) {
                    checkTouchResult.endPoint = next;
                    break;
                }
            }
            zCheckEndPoint = zCheckEndPoint2;
        }
    ...
    public boolean onTouch(MotionEvent motionEvent) {
        ...
        float absoluteLeft = x2 - getAbsoluteLeft();
        float absoluteTop = y2 - getAbsoluteTop();
        ...
        if (actionMasked == 0) {
            ...
            if (this.mMoving) {
                MamlLog.i(LOG_TAG, "unlock touch up");
    ...
    public abstract class ReboundAnimationController implements ITicker {
        ...
        private Utils.Point getPoint(float f2, float f3, float f4, float f5, long j2) {
            ...
            double d3 = (dDist - d2) / dDist;
            double d4 = point2.f2562x;
            double d5 = point.f2562x;
            double d6 = point2.f2563y;
            double d7 = point.f2563y;
            return new Utils.Point(d5 + ((d4 - d5) * d3), d7 + ((d6 - d7) * d3));
        }

        public abstract long getDistance(long j2);
                ...
                if (endPoint != null && endPoint.mPath != null) {
                    ...
                    while (true) {
                        ...
                        if (point != null) {
                            ...
                            onMove((float) point.f2562x, (float) point.f2563y);
                            break;
                        } else {
                            if (i2 == 0) {
                                onStop();
                    ...
                    if (point2 == null) {
                        ...
                        onMove((float) point2.f2562x, (float) point2.f2563y);
                    }
                }

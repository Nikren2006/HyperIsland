...
public class MusicLyricParser {
    ...
    public static class Lyric {
        ...
        public class LyricLocator {
            ...
            private int getLineNumber(long j2) {
                ...
                while (true) {
                    ...
                    if (j2 >= iArr[i2]) {
                        if (j2 < (i2 < iArr.length + (-1) ? iArr[i2 + 1] : LocationRequestCompat.PASSIVE_INTERVAL)) {
                            return i2;
                        }
                    }
                    i2++;
        ...
        private long getTimeFromLyricShot(int i2, double d2) {
            int size = size() - 1;
            return i2 >= size ? ((long) (this.mEntityList.get(size).time + ((i2 - size) * MusicLyricParser.INTERVAL_OF_LAST))) + ((long) (d2 * 8000.0d)) : (long) (((double) this.mEntityList.get(i2).time) + (((double) (this.mEntityList.get(i2 + 1).time - this.mEntityList.get(i2).time)) * d2));
        }
        ...
        public void correctLyric(LyricShot lyricShot, int i2, double d2) {
            ...
            boolean z2 = i2 <= i4 && (i2 != i4 || d2 <= lyricShot.percent);
    ...
    private static Lyric doParse(String str) {
    ...
    private static int parseLine(String str, LyricHeader lyricHeader, ArrayList<LyricEntity> arrayList) {
        ...
        for (String str2 : strArrSplit) {
            if (str2.startsWith("[")) {
                ...
                String[] strArrSplit2 = strSubstring2.split(MethodCodeHelper.IDENTITY_INFO_SEPARATOR);

...
public class VariableElement extends ScreenElement {
    ...
    /* JADX INFO: renamed from: com.miui.maml.elements.VariableElement$1, reason: invalid class name */
    ...
    public VariableElement(Element element, ScreenElementRoot screenElementRoot) {
        ...
        if (element != null) {
            ...
            this.mIndexExpression = Expression.build(getVariables(), element.getAttribute(QsFlipEventsKt.EVENT_KEY_FLIP_QS_INDEX));
            ...
            if (this.mType.isArray()) {
                ...
                if (i2 <= 0) {
                    MamlLog.e(LOG_TAG, "array size is 0:" + this.mName);
                } else if (!variables.createArray(this.mName, i2, this.mType.mTypeClass)) {
                    MamlLog.e(LOG_TAG, "fail to create array:" + this.mName);
                    this.mArraySize = 0;
                }
    ...
    private double getDouble(boolean z2, int i2) {
        ...
        return z2 ? indexedVariable.getArrDouble(i2) : indexedVariable.getDouble();
    }
    ...
    private void update() {
        ...
        if (i2 == 1) {
            VariableAnimation variableAnimation = this.mAnimation;
            if (variableAnimation != null && TypedValues.Custom.S_COLOR.equals(variableAnimation.getType())) {
        ...
        if (i2 != 2) {
            ...
            if (this.mType.isNumberArray()) {
                ...
                if (expression3 != null) {
                    ...
                    double d3 = getDouble(true, iEvaluate);
                    this.mVar.setArr(iEvaluate, d3);
                    onValueChange(d3);
                    return;
                }

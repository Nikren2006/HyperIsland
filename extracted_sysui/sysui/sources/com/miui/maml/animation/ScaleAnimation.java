...
public class ScaleAnimation extends BaseAnimation {
    ...
    public ScaleAnimation(Element element, ScreenElement screenElement) {
        super(element, ListScreenElement.ListItemElement.TAG_NAME, new String[]{ah.f2836p, AnimatedProperty.PROPERTY_NAME_X, AnimatedProperty.PROPERTY_NAME_Y}, screenElement);

...
public class CommandTrigger {
    ...
    private void load(Element element, ScreenElement screenElement) {
        ...
        String attribute = element.getAttribute(TypedValues.AttributesType.S_TARGET);
        String attribute2 = element.getAttribute("property");
        String attribute3 = element.getAttribute(ah.f2836p);
        ...
        this.mActionStrings = element.getAttribute(com.xiaomi.onetrack.api.a.f2741a).split(aa.f3429b);

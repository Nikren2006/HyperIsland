...
public final class BrightnessPanelSliderDelegate extends SecondaryPanelDelegateBase<BrightnessPanelParams> {
    ...
    /* JADX WARN: Type inference failed for: r2v2, types: [miui.systemui.controlcenter.panel.secondary.brightness.BrightnessPanelSliderDelegate$seekBarListener$1] */
    public BrightnessPanelSliderDelegate(ControlCenterSecondaryBinding secondaryBinding, BrightnessPanelBinding binding, GestureDispatcher gestureDispatcher, ActivityStarter activityStarter, BrightnessControllerBase brightnessController, HapticFeedback hapticFeedback) {
        ...
        this.seekBarListener = new SeekBar.OnSeekBarChangeListener() { // from class: miui.systemui.controlcenter.panel.secondary.brightness.BrightnessPanelSliderDelegate$seekBarListener$1
            ...
            public void onStopTrackingTouch(SeekBar seekBar) {
                ...
                if (progress - this.preValue == 0 || this.this$0.binding.getRoot().isShown()) {
                    return;
                }
                ControlCenterEventTracker.Companion.trackBrightnessSeekbarAdjustEvent(true, EventTracker.Companion.getScreenType(this.this$0.getContext()), this.preValue, this.afterValue);
            }
        };
    ...
    public final NoTransformTouchFrameLayout getVToggleSliderInner() {
        ...
        n.f(toggleSliderInner, "toggleSliderInner");

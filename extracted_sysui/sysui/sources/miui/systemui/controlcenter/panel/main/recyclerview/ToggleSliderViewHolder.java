...
import miui.systemui.controlcenter.widget.VerticalSeekBarTouchAnim;
...
public final class ToggleSliderViewHolder extends MultipleAnimViewHolder implements SliderFromView {
    ...
    public static final class Factory {
        ...
        public Factory(GestureDispatcher gestureDispatcher, ActivityStarter activityStarter, ShadeSwitchController shadeSwitchController, BrightnessControllerBase brightnessController, StatusBarStateController statusBarStateController, BlurUtilsExt blurUtilsExt, ControlCenterExpandController expandController) {
        ...
        public final ToggleSliderViewHolder create(ToggleSliderItemViewBinding binding) {
            ...
            n.f(brightnessMirrorBlurProvider, "getBrightnessMirrorBlurProvider(...)");
            return new ToggleSliderViewHolder(binding, brightnessMirrorBlurProvider, this.gestureDispatcher, this.activityStarter, this.shadeSwitchController, this.statusBarStateController, this.blurUtilsExt, this.expandController);
        }
    }

    /* JADX WARN: Illegal instructions before constructor call */
    public ToggleSliderViewHolder(ToggleSliderItemViewBinding binding, View mirrorBlurProvider, GestureDispatcher gestureDispatcher, ActivityStarter activityStarter, ShadeSwitchController shadeSwitchController, StatusBarStateController statusBarStateController, BlurUtilsExt blurUtilsExt, ControlCenterExpandController expandController) {
        n.g(binding, "binding");
        n.g(mirrorBlurProvider, "mirrorBlurProvider");
        n.g(gestureDispatcher, "gestureDispatcher");
        n.g(activityStarter, "activityStarter");
        n.g(shadeSwitchController, "shadeSwitchController");
        n.g(statusBarStateController, "statusBarStateController");
        ...
        slider.setToggleSliderView(binding.getRoot());
        ...
        slider.getTouchAnim().setTouchCallback(new VerticalSeekBarTouchAnim.TouchCallback() { // from class: miui.systemui.controlcenter.panel.main.recyclerview.ToggleSliderViewHolder$1$2
            @Override // miui.systemui.controlcenter.widget.VerticalSeekBarTouchAnim.TouchCallback
    ...
    public void updateBlendBlur() {
        ...
        if (this.inMirror) {
            ...
            MiBlurCompat.setPassWindowBlurEnabledCompat(this.mirrorBlurProvider, !zIsLocked || CommonUtils.INSTANCE.isDefaultTheme());

...
@ControlCenterScope
public final class EmptyHeaderMirrorController extends ControlCenterViewController<View> implements ShadeHeader {
    ...
    public EmptyHeaderMirrorController(Context context, ShadeHeaderController shadeHeaderController, @Qualifiers.ControlCenter Lifecycle lifecycle, E0.a brightnessSliderController, E0.a secondaryPanelRouter) {
    ...
    public boolean getShouldShow() {
        ...
        return currentState.compareTo(state) >= 0 && ((BrightnessSliderController) this.brightnessSliderController.get()).getLifecycle().getCurrentState().compareTo(state) >= 0;
    }

...
public final class QSController$compactTileSpecs$2 extends o implements Function0 {
    ...
    public final List<String> invoke() {
        String[] stringArray = this.this$0.getResources().getStringArray(R.array.compact_tiles);

...
public final class MiSmartHubClickEvent {
    ...
    public boolean equals(Object obj) {
        ...
        return n.c(this.trackId, miSmartHubClickEvent.trackId) && n.c(this.modelType, miSmartHubClickEvent.modelType) && n.c(this.phoneType, miSmartHubClickEvent.phoneType) && n.c(this.screenType, miSmartHubClickEvent.screenType) && n.c(this.version, miSmartHubClickEvent.version) && n.c(this.orientation, miSmartHubClickEvent.orientation) && n.c(this.style, miSmartHubClickEvent.style) && n.c(this.tip, miSmartHubClickEvent.tip);
    }
    ...
    public /* synthetic */ MiSmartHubClickEvent(String str, String str2, String str3, String str4, String str5, String str6, String str7, String str8, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this(str, str2, str3, str4, str5, str6, str7, (i2 & 128) != 0 ? "178.1.1.1.18009" : str8);
    }
}

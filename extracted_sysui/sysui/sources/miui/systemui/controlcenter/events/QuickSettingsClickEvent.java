...
@EventID(id = "click")
public final class QuickSettingsClickEvent {
    ...
    public QuickSettingsClickEvent(String trackId, String modelType, String phoneType, String screenType, String version, String style, int i2, String orientation, String qsName, String qsTitle, String elementStyle, String switchFrom, String clickStatus, String tip) {
        n.g(trackId, "trackId");
    ...
    public final QuickSettingsClickEvent copy(String trackId, String modelType, String phoneType, String screenType, String version, String style, int i2, String orientation, String qsName, String qsTitle, String elementStyle, String switchFrom, String clickStatus, String tip) {
        n.g(trackId, "trackId");
        n.g(modelType, "modelType");
        n.g(phoneType, "phoneType");
        n.g(screenType, "screenType");
        ...
        n.g(clickStatus, "clickStatus");
        n.g(tip, "tip");
        return new QuickSettingsClickEvent(trackId, modelType, phoneType, screenType, version, style, i2, orientation, qsName, qsTitle, elementStyle, switchFrom, clickStatus, tip);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof QuickSettingsClickEvent)) {
            return false;
        }
        QuickSettingsClickEvent quickSettingsClickEvent = (QuickSettingsClickEvent) obj;
        return n.c(this.trackId, quickSettingsClickEvent.trackId) && n.c(this.modelType, quickSettingsClickEvent.modelType) && n.c(this.phoneType, quickSettingsClickEvent.phoneType) && n.c(this.screenType, quickSettingsClickEvent.screenType) && n.c(this.version, quickSettingsClickEvent.version) && n.c(this.style, quickSettingsClickEvent.style) && this.index == quickSettingsClickEvent.index && n.c(this.orientation, quickSettingsClickEvent.orientation) && n.c(this.qsName, quickSettingsClickEvent.qsName) && n.c(this.qsTitle, quickSettingsClickEvent.qsTitle) && n.c(this.elementStyle, quickSettingsClickEvent.elementStyle) && n.c(this.switchFrom, quickSettingsClickEvent.switchFrom) && n.c(this.clickStatus, quickSettingsClickEvent.clickStatus) && n.c(this.tip, quickSettingsClickEvent.tip);
    }
    ...
    public String toString() {
        return "QuickSettingsClickEvent(trackId=" + this.trackId + ", modelType=" + this.modelType + ", phoneType=" + this.phoneType + ", screenType=" + this.screenType + ", version=" + this.version + ", style=" + this.style + ", index=" + this.index + ", orientation=" + this.orientation + ", qsName=" + this.qsName + ", qsTitle=" + this.qsTitle + ", elementStyle=" + this.elementStyle + ", switchFrom=" + this.switchFrom + ", clickStatus=" + this.clickStatus + ", tip=" + this.tip + ")";
    }

    public /* synthetic */ QuickSettingsClickEvent(String str, String str2, String str3, String str4, String str5, String str6, int i2, String str7, String str8, String str9, String str10, String str11, String str12, String str13, int i3, DefaultConstructorMarker defaultConstructorMarker) {

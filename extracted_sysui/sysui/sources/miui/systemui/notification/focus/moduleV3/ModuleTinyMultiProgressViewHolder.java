...
public final class ModuleTinyMultiProgressViewHolder extends ModuleViewHolder {
    ...
    public ModuleTinyMultiProgressViewHolder(Context ctx, Context sysuiCtx, ViewGroup rootView, boolean z2) {
    ...
    public void initView(String module) {
        ...
        setView(LayoutInflater.from(ModuleViewHolder.getContext$default(this, false, 1, null)).inflate(R.layout.focus_notification_module_tiny_multi_progress, getRootView()));
        View view = getView();

...
public final class ModuleDecoLandImageTextHighlightViewHolder extends ModuleViewHolder {
    ...
    public ModuleDecoLandImageTextHighlightViewHolder(Context ctx, Context sysuiCtx, ViewGroup rootView, boolean z2) {
    ...
    public void bind(Template template, StatusBarNotification sbn) {
        ...
        if (TextUtils.isEmpty(getTitle())) {
            ...
            if (textView4 != null) {
                textView4.setText(Html.fromHtml(getTitle()));
            }
        }
        ...
        if (content != null && content.length() > 0) {
            ...
            if (contentColor != null) {
                ...
                if (textView6 != null) {
                    textView6.setTextColor(iIntValue3);
                }
            }
            TextView textView7 = this.focusContent;
            if (textView7 != null) {
                textView7.setText(Html.fromHtml(getContent()));
            }
        }
        ...
        if (subContent != null && subContent.length() > 0) {
            ...
            if (subContentColor != null) {
                ...
                if (textView9 != null) {
                    textView9.setTextColor(iIntValue4);
                }
            }
            TextView textView10 = this.focusSubContent;
            if (textView10 != null) {
                textView10.setText(Html.fromHtml(getSubContent()));
            }
        }
        HighlightInfo highlightInfo2 = template.getHighlightInfo();
    ...
    public void initView(String module) {
        ...
        setView(kotlin.jvm.internal.n.c(module, Const.Module.MODULE_IMAGE_TEXT_HIGHLIGHT_TIME) ? LayoutInflater.from(ModuleViewHolder.getContext$default(this, false, 1, null)).inflate(R.layout.focus_notification_module_deco_land_image_text_highlight_timer, getRootView()) : LayoutInflater.from(ModuleViewHolder.getContext$default(this, false, 1, null)).inflate(R.layout.focus_notification_module_deco_land_image_text_highlight_sport, getRootView()));
        View view = getView();

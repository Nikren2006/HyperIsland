...
public final class ModuleDecoLandMarkViewHolder extends ModuleViewHolder {
    ...
    public ModuleDecoLandMarkViewHolder(Context ctx, Context sysuiCtx, ViewGroup rootView, boolean z2) {
    ...
    */
    public void bind(miui.systemui.notification.focus.model.Template r9, android.service.notification.StatusBarNotification r10) throws java.net.URISyntaxException {
        ...
        La2:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: miui.systemui.notification.focus.moduleV3.ModuleDecoLandMarkViewHolder.bind(miui.systemui.notification.focus.model.Template, android.service.notification.StatusBarNotification):void");
    }
    ...
    */
    public void initView(java.lang.String r3) {
        ...
        L3b:
            android.content.Context r3 = r2.getCtx()
            android.view.LayoutInflater r3 = android.view.LayoutInflater.from(r3)
            int r0 = com.android.systemui.miui.notification.R.layout.focus_notification_module_deco_land_mark_2
            android.view.ViewGroup r1 = r2.getRootView()
            android.view.View r3 = r3.inflate(r0, r1)
            r2.setView(r3)
            goto L84
        ...
        L59:
            android.content.Context r3 = r2.getCtx()
            android.view.LayoutInflater r3 = android.view.LayoutInflater.from(r3)
            int r0 = com.android.systemui.miui.notification.R.layout.focus_notification_module_deco_land_mark_4
            android.view.ViewGroup r1 = r2.getRootView()
            android.view.View r3 = r3.inflate(r0, r1)
            r2.setView(r3)
            goto L84
        L6f:
            android.content.Context r3 = r2.getCtx()
            android.view.LayoutInflater r3 = android.view.LayoutInflater.from(r3)
            int r0 = com.android.systemui.miui.notification.R.layout.focus_notification_module_deco_land_mark_1
            android.view.ViewGroup r1 = r2.getRootView()
            android.view.View r3 = r3.inflate(r0, r1)
            r2.setView(r3)
        L84:
        ...
        Lb3:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: miui.systemui.notification.focus.moduleV3.ModuleDecoLandMarkViewHolder.initView(java.lang.String):void");
    }

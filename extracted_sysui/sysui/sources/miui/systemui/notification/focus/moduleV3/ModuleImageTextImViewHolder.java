...
public final class ModuleImageTextImViewHolder extends ModuleViewHolder {
    ...
    public ModuleImageTextImViewHolder(Context ctx, Context sysuiCtx, ViewGroup rootView, boolean z2, boolean z3) {
    ...
    */
    private final void showProfilePicture(miui.systemui.notification.focus.model.Template r6, android.service.notification.StatusBarNotification r7) {
        ...
        Lb4:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: miui.systemui.notification.focus.moduleV3.ModuleImageTextImViewHolder.showProfilePicture(miui.systemui.notification.focus.model.Template, android.service.notification.StatusBarNotification):void");
    }
    ...
    public void initView(String module) {
        ...
        setView(LayoutInflater.from(getContext(this.island)).inflate(R.layout.focus_notification_module_image_text_im, getRootView()));
        View view = getView();

...
public final class ModuleDecoPortCoverViewHolder extends ModuleViewHolder {
    ...
    public ModuleDecoPortCoverViewHolder(Context ctx, Context sysuiCtx, ViewGroup rootView, boolean z2) {
    ...
    public void bind(Template template, StatusBarNotification sbn) {
        ...
        if ((picInfo != null ? picInfo.getType() : null) != null) {
    ...
    public void initView(String module) {
        ...
        setView(LayoutInflater.from(ModuleViewHolder.getContext$default(this, false, 1, null)).inflate(R.layout.focus_notification_module_deco_port_cover, getRootView()));
        View view = getView();
        this.container = view != null ? view.findViewById(R.id.focus_container_module_cover) : null;
        View view2 = getView();
        this.iconContainer = view2 != null ? view2.findViewById(R.id.focus_icon_container) : null;
        View view3 = getView();
        ...
        TimerTextEffectView timerTextEffectView3 = this.focusSubContent;
        if (timerTextEffectView3 != null) {

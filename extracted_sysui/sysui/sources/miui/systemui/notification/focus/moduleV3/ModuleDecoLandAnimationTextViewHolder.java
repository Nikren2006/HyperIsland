...
public final class ModuleDecoLandAnimationTextViewHolder extends ModuleViewHolder implements FullAodStatusManager.IFullAodStatusObserver {
    ...
    /* JADX INFO: renamed from: miui.systemui.notification.focus.moduleV3.ModuleDecoLandAnimationTextViewHolder$fullAodStatusChanged$1, reason: invalid class name */
    @N0.f(c = "miui.systemui.notification.focus.moduleV3.ModuleDecoLandAnimationTextViewHolder$fullAodStatusChanged$1", f = "ModuleDecoLandAnimationTextViewHolder.kt", l = {}, m = "invokeSuspend")
    public static final class AnonymousClass1 extends N0.l implements Function2 {
        ...
        public final L0.d create(Object obj, L0.d dVar) {
            return ModuleDecoLandAnimationTextViewHolder.this.new AnonymousClass1(this.$fullAodStatus, dVar);
        }
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            H0.k.b(obj);
            if (ModuleDecoLandAnimationTextViewHolder.this.focusAnimation == null) {
                return H0.s.f314a;
            }
            if (this.$fullAodStatus) {
                LottieAnimationView lottieAnimationView2 = ModuleDecoLandAnimationTextViewHolder.this.focusAnimation;
                if (lottieAnimationView2 != null) {
                    lottieAnimationView2.setProgress(1.0f);
                }
                LottieAnimationView lottieAnimationView3 = ModuleDecoLandAnimationTextViewHolder.this.focusAnimation;
                if (lottieAnimationView3 != null) {
                    lottieAnimationView3.pauseAnimation();
                }
            } else if (ModuleDecoLandAnimationTextViewHolder.this.isAutoPlay && (lottieAnimationView = ModuleDecoLandAnimationTextViewHolder.this.focusAnimation) != null) {
    ...
    /* JADX INFO: renamed from: miui.systemui.notification.focus.moduleV3.ModuleDecoLandAnimationTextViewHolder$onDetach$1, reason: invalid class name and case insensitive filesystem */
    @N0.f(c = "miui.systemui.notification.focus.moduleV3.ModuleDecoLandAnimationTextViewHolder$onDetach$1", f = "ModuleDecoLandAnimationTextViewHolder.kt", l = {}, m = "invokeSuspend")
    public static final class C06751 extends N0.l implements Function2 {
        int label;

        public C06751(L0.d dVar) {
            super(2, dVar);
        }

        @Override // N0.a
        public final L0.d create(Object obj, L0.d dVar) {
            return ModuleDecoLandAnimationTextViewHolder.this.new C06751(dVar);
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(E e2, L0.d dVar) {
            return ((C06751) create(e2, dVar)).invokeSuspend(H0.s.f314a);
        }
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            H0.k.b(obj);
            LottieResUtils.cancelLottieAnimate$default(LottieResUtils.INSTANCE, ModuleDecoLandAnimationTextViewHolder.this.focusAnimation, false, 2, null);
            return H0.s.f314a;
        }
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ModuleDecoLandAnimationTextViewHolder(Context ctx, Context sysuiCtx, ViewGroup rootView, boolean z2) {
    ...
    private final void playAnimation(final Template template, StatusBarNotification statusBarNotification) {
        ...
        boolean zC = false;
        AbstractC0315p.s(ModuleViewHolder.getContext$default(this, false, 1, null), LottieResUtils.getLottieRes$default(lottieResUtils, (animTextInfo == null || (animIconInfo2 = animTextInfo.getAnimIconInfo()) == null) ? null : animIconInfo2.getSrc(), 0, 2, null)).d(new H() { // from class: miui.systemui.notification.focus.moduleV3.f
            @Override // d.H
            public final void onResult(Object obj) {
                ModuleDecoLandAnimationTextViewHolder.playAnimation$lambda$2(this.f5831a, template, (C0307h) obj);
            }
        });
    ...
    */
    public static final void playAnimation$lambda$2(miui.systemui.notification.focus.moduleV3.ModuleDecoLandAnimationTextViewHolder r3, miui.systemui.notification.focus.model.Template r4, d.C0307h r5) {
        /*
        ...
        L88:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: miui.systemui.notification.focus.moduleV3.ModuleDecoLandAnimationTextViewHolder.playAnimation$lambda$2(miui.systemui.notification.focus.moduleV3.ModuleDecoLandAnimationTextViewHolder, miui.systemui.notification.focus.model.Template, d.h):void");
    }
    ...
    public void initView(String module) {
        ...
        setView(LayoutInflater.from(ModuleViewHolder.getContext$default(this, false, 1, null)).inflate(R.layout.focus_notification_module_deco_land_animation_text, getRootView()));
        View view = getView();
    ...
    public void onDetach() {
        ...
        AbstractC0369g.b(getScope(), null, null, new C06751(null), 3, null);
        super.onDetach();
    }

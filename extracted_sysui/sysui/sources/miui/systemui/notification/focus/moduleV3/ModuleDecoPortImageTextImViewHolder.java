...
public final class ModuleDecoPortImageTextImViewHolder extends ModuleViewHolder {
    ...
    public ModuleDecoPortImageTextImViewHolder(Context ctx, Context sysuiCtx, ViewGroup rootView, boolean z2) {
    ...
    public void initView(String module) {
        ...
        setView(LayoutInflater.from(ModuleViewHolder.getContext$default(this, false, 1, null)).inflate(R.layout.focus_notification_module_deco_port_image_text_im, getRootView()));
        View view = getView();

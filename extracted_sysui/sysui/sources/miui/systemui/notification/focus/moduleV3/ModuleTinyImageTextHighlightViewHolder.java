...
public final class ModuleTinyImageTextHighlightViewHolder extends ModuleViewHolder {
    ...
    public ModuleTinyImageTextHighlightViewHolder(Context ctx, Context sysuiCtx, ViewGroup rootView, boolean z2) {
    ...
    public void bind(Template template, StatusBarNotification sbn) {
        ...
        if (subContent != null && subContent.length() > 0) {
            ...
            if (textView9 != null) {
                textView9.setText(Html.fromHtml(getSubContent()));
            }
    ...
    public void initView(String module) {
        ...
        setView(kotlin.jvm.internal.n.c(module, Const.Module.MODULE_IMAGE_TEXT_HIGHLIGHT_TIME) ? LayoutInflater.from(ModuleViewHolder.getContext$default(this, false, 1, null)).inflate(R.layout.focus_notification_module_tiny_image_text_highlight_timer, getRootView()) : LayoutInflater.from(ModuleViewHolder.getContext$default(this, false, 1, null)).inflate(R.layout.focus_notification_module_tiny_image_text_highlight_sport, getRootView()));
        View view = getView();

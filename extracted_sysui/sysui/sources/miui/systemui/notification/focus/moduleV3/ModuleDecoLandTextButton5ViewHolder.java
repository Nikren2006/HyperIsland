...
public final class ModuleDecoLandTextButton5ViewHolder extends ModuleViewHolder {
    private View action;
    ...
    public ModuleDecoLandTextButton5ViewHolder(Context ctx, Context sysuiCtx, ViewGroup rootView, boolean z2) {
    ...
    public void initView(String module) {
        ...
        setView(LayoutInflater.from(ModuleViewHolder.getContext$default(this, false, 1, null)).inflate(R.layout.focus_notification_module_deco_land_button_5, getRootView()));
        View view = getView();

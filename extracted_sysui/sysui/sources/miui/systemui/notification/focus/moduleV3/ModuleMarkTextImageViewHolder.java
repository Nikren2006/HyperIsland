...
public final class ModuleMarkTextImageViewHolder extends ModuleViewHolder {
    ...
    public ModuleMarkTextImageViewHolder(Context ctx, Context sysuiCtx, ViewGroup rootView, boolean z2, boolean z3) {
    ...
    private final void showMarkIcon(StatusBarNotification statusBarNotification) {
        ...
        if (DrawableUtils.isSameIcon(icon, this.currentIcon)) {
            return;
        }
        View view = getView();
    ...
    public void initView(String module) {
        ...
        setModule(module);
        setView(LayoutInflater.from(getCtx()).inflate(R.layout.focus_notification_module_mark_text_image, getRootView()));
        View view = getView();
        ...
        HyperChronometer hyperChronometer3 = this.focusTitle;
        if (hyperChronometer3 != null) {
            hyperChronometer3.enableEffect(!CommonUtils.NOT_SUPPORT_TEXT_EFFECT);
        }
    }

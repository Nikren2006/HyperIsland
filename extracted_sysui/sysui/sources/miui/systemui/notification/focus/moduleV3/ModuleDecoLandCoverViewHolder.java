...
public final class ModuleDecoLandCoverViewHolder extends ModuleViewHolder {
    ...
    public ModuleDecoLandCoverViewHolder(Context ctx, Context sysuiCtx, ViewGroup rootView, boolean z2) {
    ...
    public void initView(String module) {
        ...
        setView(LayoutInflater.from(ModuleViewHolder.getContext$default(this, false, 1, null)).inflate(R.layout.focus_notification_module_deco_land_cover, getRootView()));
        View view = getView();

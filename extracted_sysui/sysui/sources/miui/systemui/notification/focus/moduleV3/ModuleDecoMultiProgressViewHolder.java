...
public final class ModuleDecoMultiProgressViewHolder extends ModuleViewHolder {
    ...
    public ModuleDecoMultiProgressViewHolder(Context ctx, Context sysuiCtx, ViewGroup rootView, boolean z2) {
    ...
    private final List<NotificationProgressDrawable.Part> convertToDrawableParts(int i2, int i3, String str) {
        ...
        Log.d(ModuleViewHolder.TAG, " get Parts=" + arrayList);
        return arrayList;
    }
    ...
    private final void showMultiProgress(Template template, StatusBarNotification statusBarNotification) {
        ...
        if (multiProgressInfo != null) {
            if (multiProgressInfo.getProgress() < 0 || multiProgressInfo.getPoints() < 0) {
                Log.e(ModuleViewHolder.TAG, " multiProgressInfo empty or values are negative !!!");
                return;
            }
            if (multiProgressInfo.getProgress() > 100) {
                Log.w(ModuleViewHolder.TAG, " multiProgressInfo progress > 100, reduced to 100");
                multiProgressInfo.setProgress(100);
            } else if (multiProgressInfo.getPoints() > 4) {
                Log.w(ModuleViewHolder.TAG, " multiProgressInfo points > 4, limited to 4");
    ...
    public void initView(String module) {
        ...
        setView(LayoutInflater.from(ModuleViewHolder.getContext$default(this, false, 1, null)).inflate(R.layout.focus_notification_module_multi_progress, getRootView()));
        View view = getView();

...
public final class DynamicIslandShareViewBinding implements ViewBinding {
    ...
    public static DynamicIslandShareViewBinding bind(@NonNull View view) {
        ...
        if (textView != null) {
            ...
            if (imageView != null) {
                ...
                if (textView2 != null) {
                    return new DynamicIslandShareViewBinding((LinearLayout) view, textView, imageView, textView2);
                }
            }
        }
    ...
    @NonNull
    public static DynamicIslandShareViewBinding inflate(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z2) {
        View viewInflate = layoutInflater.inflate(R.layout.dynamic_island_share_view, viewGroup, false);
        if (z2) {

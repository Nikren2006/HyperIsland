...
public final class DynamicIslandModuleRightTextBinding implements ViewBinding {
    ...
    private DynamicIslandModuleRightTextBinding(@NonNull FrameLayout frameLayout, @NonNull FrameLayout frameLayout2, @NonNull TimerTextEffectView timerTextEffectView, @NonNull TimerTextEffectView timerTextEffectView2, @NonNull View view, @NonNull TimerTextEffectView timerTextEffectView3) {
        ...
        if (timerTextEffectView != null) {
            ...
            if (timerTextEffectView2 != null && (viewFindChildViewById = ViewBindings.findChildViewById(view, (i2 = R.id.island_text_shade))) != null) {
                ...
                if (timerTextEffectView3 != null) {
                    return new DynamicIslandModuleRightTextBinding(frameLayout, frameLayout, timerTextEffectView, timerTextEffectView2, viewFindChildViewById, timerTextEffectView3);
                }
            }
        }
    ...
    @NonNull
    public static DynamicIslandModuleRightTextBinding inflate(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z2) {
        View viewInflate = layoutInflater.inflate(R.layout.dynamic_island_module_right_text, viewGroup, false);
        if (z2) {

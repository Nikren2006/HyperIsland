...
public final class DeviceCenterCardExposeHMEvent implements DeviceCenterEvent {
    ...
    public DeviceCenterCardExposeHMEvent(String deviceClassification, String device, String refDeviceId, String refDeviceModel, String refDeviceStatus, String hyperMindEntranceStatus, String refPlatformNumber, String deviceNupositionmberStatus, String page, String group) {
    ...
    public final DeviceCenterCardExposeHMEvent copy(String deviceClassification, String device, String refDeviceId, String refDeviceModel, String refDeviceStatus, String hyperMindEntranceStatus, String refPlatformNumber, String deviceNupositionmberStatus, String page, String group) {
        n.g(deviceClassification, "deviceClassification");
        n.g(device, "device");
        n.g(refDeviceId, "refDeviceId");
        n.g(refDeviceModel, "refDeviceModel");
        ...
        n.g(page, "page");
        n.g(group, "group");
        return new DeviceCenterCardExposeHMEvent(deviceClassification, device, refDeviceId, refDeviceModel, refDeviceStatus, hyperMindEntranceStatus, refPlatformNumber, deviceNupositionmberStatus, page, group);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof DeviceCenterCardExposeHMEvent)) {
            return false;
        }
        DeviceCenterCardExposeHMEvent deviceCenterCardExposeHMEvent = (DeviceCenterCardExposeHMEvent) obj;
        return n.c(this.deviceClassification, deviceCenterCardExposeHMEvent.deviceClassification) && n.c(this.device, deviceCenterCardExposeHMEvent.device) && n.c(this.refDeviceId, deviceCenterCardExposeHMEvent.refDeviceId) && n.c(this.refDeviceModel, deviceCenterCardExposeHMEvent.refDeviceModel) && n.c(this.refDeviceStatus, deviceCenterCardExposeHMEvent.refDeviceStatus) && n.c(this.hyperMindEntranceStatus, deviceCenterCardExposeHMEvent.hyperMindEntranceStatus) && n.c(this.refPlatformNumber, deviceCenterCardExposeHMEvent.refPlatformNumber) && n.c(this.deviceNupositionmberStatus, deviceCenterCardExposeHMEvent.deviceNupositionmberStatus) && n.c(this.page, deviceCenterCardExposeHMEvent.page) && n.c(this.group, deviceCenterCardExposeHMEvent.group);
    }
    ...
    public /* synthetic */ DeviceCenterCardExposeHMEvent(String str, String str2, String str3, String str4, String str5, String str6, String str7, String str8, String str9, String str10, int i2, DefaultConstructorMarker defaultConstructorMarker) {

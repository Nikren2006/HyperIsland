...
public abstract class DynamicAnimation<T extends DynamicAnimation<T>> implements AnimationHandler.AnimationFrameCallback {
    ...
    private static final int MI_MOTION_MAX_DELTA_TIME_NANOS = 1000000000;
    ...
    public static final ViewProperty f6135X = new ViewProperty(AnimatedProperty.PROPERTY_NAME_X) { // from class: miuix.overscroller.internal.dynamicanimation.animation.DynamicAnimation.9
        @Override // miuix.overscroller.internal.dynamicanimation.animation.FloatPropertyCompat
        public float getValue(View view) {
            return view.getX();
        }
    ...
    public static final ViewProperty f6136Y = new ViewProperty(AnimatedProperty.PROPERTY_NAME_Y) { // from class: miuix.overscroller.internal.dynamicanimation.animation.DynamicAnimation.10
        @Override // miuix.overscroller.internal.dynamicanimation.animation.FloatPropertyCompat
        public float getValue(View view) {
            return view.getY();
        }
    ...
    public static final ViewProperty f6137Z = new ViewProperty("z") { // from class: miuix.overscroller.internal.dynamicanimation.animation.DynamicAnimation.11
        @Override // miuix.overscroller.internal.dynamicanimation.animation.FloatPropertyCompat
        public float getValue(View view) {
            return view.getZ();
        }
    ...
    private void startAnimationInternal(boolean z2) {
        if (this.mRunning) {
            return;
        }
        this.mRunning = true;
    ...
    public boolean doAnimationFrame(long j2) {
        ...
        long jMin = (!fromFramePeriodNsecs || frameDeltaNanos == 0) ? Math.min(frameDeltaNanos, FolmeEngine.MAX_DELTA) : Math.min(frameDeltaNanos, FolmeCore.NANOS_TO_S);
        this.mLastFrameTimeNanos = j2;
        boolean zUpdateValueAndVelocity = updateValueAndVelocity(jMin);

...
class ActivityOptionsCompat {
    ...
    public static ActivityOptions makeScaleUpDown(View view, Bitmap bitmap, int i2, int i3, int i4, int i5, float f2, Handler handler, Runnable runnable, Runnable runnable2, Runnable runnable3, Runnable runnable4, int i6) {

...
public abstract class FragmentStateAdapter extends RecyclerView.Adapter<FragmentViewHolder> implements StatefulAdapter {
    ...
    public class FragmentMaxLifecycleEnforcer {
        ...
        private OriginalViewPager2.OnPageChangeCallback mPageChangeCallback;
        ...
        @NonNull
        private OriginalViewPager2 inferViewPager(@NonNull RecyclerView recyclerView) {
    ...
    private void scheduleGracePeriodEnd() {
        ...
        this.mLifecycle.addObserver(new LifecycleEventObserver() { // from class: miuix.androidbasewidget.adapter.FragmentStateAdapter.5
            @Override // androidx.lifecycle.LifecycleEventObserver
            public void onStateChanged(@NonNull LifecycleOwner lifecycleOwner, @NonNull Lifecycle.Event event) {
    ...
    private void scheduleViewAttach(final Fragment fragment, @NonNull final FrameLayout frameLayout) {
        this.mFragmentManager.registerFragmentLifecycleCallbacks(new FragmentManager.FragmentLifecycleCallbacks() { // from class: miuix.androidbasewidget.adapter.FragmentStateAdapter.3
    ...
    public void placeFragmentInViewHolder(@NonNull final FragmentViewHolder fragmentViewHolder) {
        ...
        if (shouldDelayFragmentTransactions()) {
            ...
            this.mLifecycle.addObserver(new LifecycleEventObserver() { // from class: miuix.androidbasewidget.adapter.FragmentStateAdapter.2
                @Override // androidx.lifecycle.LifecycleEventObserver
                public void onStateChanged(@NonNull LifecycleOwner lifecycleOwner, @NonNull Lifecycle.Event event) {

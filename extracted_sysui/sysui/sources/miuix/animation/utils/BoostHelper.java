...
public class BoostHelper {
    ...
    private void createManagerClassAndInstance(Context context) {
    }
    ...
    public void setTurboSchedAction(int[] iArr, long j2, Context context) {
    ...
    public void setTurboSchedActionToLittleCore(int[] iArr, long j2, Context context) {
        if (this.mTurboSchedManagerClass == null) {
            createManagerClassAndInstance(context);
        }
        if (this.mTurboSchedManagerClass == null || this.mTurboSchedManagerObject == null) {
    ...
    public void setTurboSchedActionWithBoostFrequency(int[] iArr, long j2, Context context) {
        if (this.mTurboSchedManagerClass == null) {
            createManagerClassAndInstance(context);
        }
        if (this.mTurboSchedManagerClass == null || this.mTurboSchedManagerObject == null) {
    ...
    public void setTurboSchedActionWithPriority(int[] iArr, long j2, Context context) {
        if (this.mTurboSchedManagerClass == null) {
            createManagerClassAndInstance(context);
        }
        if (this.mTurboSchedManagerClass == null || this.mTurboSchedManagerObject == null) {
    ...
    public void setTurboSchedActionWithoutBlock(int[] iArr, long j2, Context context) {
        if (this.mTurboSchedManagerClass == null) {
            createManagerClassAndInstance(context);
        }
        if (this.mTurboSchedManagerClass == null || this.mTurboSchedManagerObject == null) {

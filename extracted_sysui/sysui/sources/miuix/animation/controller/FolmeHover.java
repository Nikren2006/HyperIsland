...
public class FolmeHover extends FolmeBase implements IHoverStyle {
    ...
    public static class InnerViewHoverListener implements View.OnHoverListener {
        ...
        private float getHoverTranslationXTag(View view) {
            int i2 = R.id.miuix_animation_tag_hover_set_translation_x;
    ...
    private void actualTranslateDist(View view, MotionEvent motionEvent) {
        ...
        float x2 = this.mLocation[0] + motionEvent.getX();
        float y2 = this.mLocation[1] + motionEvent.getY();
        float fMax = Math.max(-1.0f, Math.min(1.0f, (x2 - (this.mLocation[0] + (view.getWidth() * 0.5f))) / view.getWidth()));
        float fMax2 = Math.max(-1.0f, Math.min(1.0f, (y2 - (this.mLocation[1] + (view.getHeight() * 0.5f))) / view.getHeight()));
    ...
    private void hoverEnterAuto(boolean z2, AnimConfig... animConfigArr) {
        ...
        if (!isScaleSet(hoverType) && this.mCurrentEffect != IHoverStyle.HoverEffect.NORMAL) {
    ...
    public static boolean isOnHoverView(View view, int[] iArr, MotionEvent motionEvent) {
        ...
        return x2 >= 0 && x2 <= view.getWidth() && y2 >= 0 && y2 <= view.getHeight();
    }
    ...
    private void setAutoScale() {
        ...
        map.put(hoverType, Boolean.TRUE);
        this.mState.getState(hoverType).add(ViewProperty.SCALE_X, 1.0d).add(ViewProperty.SCALE_Y, 1.0d);
    }
    ...
    private void updateHoverState(IHoverStyle.HoverEffect hoverEffect) {
        int i2 = AnonymousClass2.$SwitchMap$miuix$animation$IHoverStyle$HoverEffect[hoverEffect.ordinal()];
        if (i2 == 1) {
    ...
    public void hoverExit(MotionEvent motionEvent, AnimConfig... animConfigArr) {
        ...
        IHoverStyle.HoverType hoverType = IHoverStyle.HoverType.EXIT;
        if (isTranslationSet(hoverType) && this.mIsSetAutoTranslation) {
    ...
    public boolean isHideHover() {
        ...
        return this.mTargetWidth < 100 && this.mTargetHeight < 100 && (!(z2 = this.mIsSetAutoTranslation) || (z2 && ((hoverEffect = this.mCurrentEffect) == IHoverStyle.HoverEffect.FLOATED || hoverEffect == IHoverStyle.HoverEffect.FLOATED_WRAPPED)));
    }
    ...
    public IHoverStyle setCorner(float f2) {
        ...
        Object targetObject = this.mState.getTarget().getTargetObject();
        if (targetObject instanceof View) {
            ((View) targetObject).setTag(miuix.animation.R.id.miuix_animation_tag_view_hover_corners, Float.valueOf(f2));
        }
        return this;
    }

    @Override // miuix.animation.IHoverStyle
    public void setDarkFeedbackColor(int i2) {
        Object targetObject = this.mState.getTarget().getTargetObject();
        if (targetObject instanceof View) {
            setDarkFeedbackColor((View) targetObject, i2);
        }
    }
    ...
    private static void clearMagicPoint(View view) {
        try {
            Class.forName("android.view.View").getMethod("clearMagicPoint", null).invoke(view, null);
        } catch (Exception e2) {
    ...
    private static int getDarkFeedbackColor(View view) {
        try {
            return ((Integer) Class.forName("android.view.View").getMethod("getDarkFeedbackColor", null).invoke(view, null)).intValue();
        } catch (Exception e2) {
            Log.e("", "getDarkFeedbackColor failed , e:" + e2.toString());
            return -1;
        }
    }
    ...
    private static int getFeedbackColor(View view) {
        try {
            return ((Integer) Class.forName("android.view.View").getMethod("getFeedbackColor", null).invoke(view, null)).intValue();
        } catch (Exception e2) {
    ...
    private static float getFeedbackRadius(View view) {
        try {
            return ((Float) Class.forName("android.view.View").getMethod("getFeedbackRadius", null).invoke(view, null)).floatValue();
        } catch (Exception e2) {
    ...
    private static int getPointerShapeType(View view) {
        try {
            return ((Integer) Class.forName("android.view.View").getMethod("getPointerShapeType", null).invoke(view, null)).intValue();
        } catch (Exception e2) {
    ...
    private static boolean isMagicView(View view) {
        try {
            return ((Boolean) Class.forName("android.view.View").getMethod("isMagicView", null).invoke(view, null)).booleanValue();
        } catch (Exception e2) {
    ...
    private static boolean isWrapped(View view) {
        try {
            return ((Boolean) Class.forName("android.view.View").getMethod("isWrapped", null).invoke(view, null)).booleanValue();
        } catch (Exception e2) {
    ...
    private static void setDarkFeedbackColor(View view, int i2) {
        try {
            Class.forName("android.view.View").getMethod("setDarkFeedbackColor", Integer.TYPE).invoke(view, Integer.valueOf(i2));
        } catch (Exception e2) {
            Log.e("", "setDarkFeedbackColor failed , e:" + e2.toString());
        }
    }

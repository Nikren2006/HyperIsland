...
class StateManager {
    ...
    public AnimState getToState(IAnimTarget iAnimTarget, AnimConfigLink animConfigLink, boolean z2, Object... objArr) {
        AnimState stateByArgs = getStateByArgs(getCurrentState(), objArr);
        setAnimState(iAnimTarget, stateByArgs, animConfigLink, z2, objArr);
        return stateByArgs;
    }

    public void setAnimState(IAnimTarget iAnimTarget, AnimState animState, AnimConfigLink animConfigLink, boolean z2, Object... objArr) {
        this.mStateHelper.parse(iAnimTarget, animState, animConfigLink, z2, objArr);
    }
    ...
    public void setEase(int i2, FactorOperator... factorOperatorArr) {
        getCurrentState().getConfig().setEase(EaseManager.getStyle(i2, factorOperatorArr));
    }

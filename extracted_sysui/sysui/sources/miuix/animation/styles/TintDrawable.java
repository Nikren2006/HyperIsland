...
public class TintDrawable extends Drawable {
    ...
    public class InitTintTask implements Runnable {
        private final int mTintMode;

        public InitTintTask(int i2) {
            this.mTintMode = i2;
        }
    ...
    private boolean createBitmap(int i2, int i3) {
    ...
    private void drawHoverTint(@NonNull Canvas canvas, int i2) {
    ...
    private void drawRectRound(@NonNull Canvas canvas, int i2) {
        this.mPaint.setAntiAlias(true);
    ...
    private void perFromDrawRoundRectRelative(Canvas canvas, int i2) {
        if (this.mTouchRectRoundRect != null) {
            int i3 = AnonymousClass3.$SwitchMap$miuix$animation$ITouchStyle$TouchRectGravity[this.mTouchRectGravity.ordinal()];
            if (i3 == 1) {
    ...
    private void realPerFromDrawRoundRect(@NonNull Canvas canvas, int i2, RectF rectF) {
    ...
    public synchronized void initTintBuffer(int i2) {
        try {
            if (this.mView == null) {
                return;
            }
            ...
            if (i3 == 2) {
                ...
                if (width > 0 && height > 0) {
                    if (createBitmap(width, height)) {
                        InitTintTask initTintTask = new InitTintTask(i2);
    ...
    public synchronized void restoreOriginalDrawable() {
        try {
            clear();
            Runnable runnable = this.mInitTintTask;
            if (runnable != null) {
    ...
    public void setHoverCorner(float f2) {

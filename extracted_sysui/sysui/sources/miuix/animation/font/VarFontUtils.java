...
public class VarFontUtils {
    ...
    static {
        boolean z2 = !isFontAnimDisabled() && !isUsingThemeFont() && DeviceUtils.getTotalRam() > 6 && DeviceUtils.getDeviceLevel() > 0;
        IS_USING_VAR_FONT = z2;
        Log.w(CommonUtils.TAG, "IS_USING_VAR_FONT " + z2);
        if (z2) {
            MIUI_WGHT = new int[]{SecondaryParamsKt.FROM_BT, 200, ItemTouchHelper.Callback.DEFAULT_SWIPE_ANIMATION_DURATION, 305, 340, SearchActionModeView.ANIMATION_DURATION, DialogContract.BUTTON_SCROLL_WINDOW_HEIGHT_LIMIT_DP, 540, 630, TypedValues.TransitionType.TYPE_DURATION};
    ...
    public static int getScaleWeight(int i2, float f2, int i3, int i4) {
        float f3;
    ...
    public static void setVariationFont(TextView textView, int i2) {
        if (IS_USING_VAR_FONT) {

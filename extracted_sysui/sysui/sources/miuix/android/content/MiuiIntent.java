...
public class MiuiIntent extends SystemIntent {
    ...
    public static final String ACTION_CACHE_DUAL_WIFI_OPENWIFI = "miui.intent.DUAL_WIFI.CACHE_OPENWIFI";
    ...
    public static final String ACTION_CAPTURE_PARTIAL_SCREENSHOT = "android.intent.action.CAPTURE_PARTIAL_SCREENSHOT";
    ...
    public static final String ACTION_PASSPOINT_WIFI_LOGIN = "com.miui.action.PASSPOINT_WIFI_LOGIN";
    ...
    public static final String ACTION_SHUTDOWN_DELAY = "miui.intent.action.ACTION_SHUTDOWN_DELAY";
    ...
    public static final String ACTION_SOC_DECIMAL = "miui.intent.action.ACTION_SOC_DECIMAL";
    public static final String ACTION_SOC_DECIMAL_RATE = "miui.intent.action.ACTION_SOC_DECIMAL_RATE";
    ...
    public static final String EXTRA_IS_SLAVE = "miui.intent.extra.IS_SLAVE";
    ...
    public static final String EXTRA_SHUTDOWN_DELAY = "miui.intent.extra.shutdown_delay";
    public static final String EXTRA_SOC_DECIMAL = "miui.intent.extra.soc_decimal";
    public static final String EXTRA_SOC_DECIMAL_RATE = "miui.intent.extra.soc_decimal_rate";
    ...
    public static final String EXTRA_START_ACTIVITY_REASON = "com.android.systemui.camera_launch_source";
    ...
    public static final int EXTRA_VALUE_BASE_ACTIVITY = 4;
    public static final int EXTRA_VALUE_EXIT_ALONE = 2;
    public static final int EXTRA_VALUE_FORCE_SPLIT = 8;
    public static final int EXTRA_VALUE_SEC_ACTIVITY = 1;
    public static final int EXTRA_VALUE_SUBINTENT_ONE = 16;
    ...
    public static final int FLAG_MIUI_ACTIVITY_EXCLUDE_FROM_RECENTS = 256;
    public static final int FLAG_MIUI_CANCEL_SPLIT = 8;
    public static final int FLAG_MIUI_DUMMPY_FIRST_SPLIT = 128;
    public static final int FLAG_MIUI_FIRST_SPLIT = 64;

...
public class SmoothPathProvider {
    ...
    public static class CornerData {
        ...
        public void build(float f2, RectF rectF, float f3, float f4, double d2, float f5, int i2) {
            ...
            this.smoothForHorizontal = SmoothPathProvider.smoothForWidth(fWidth, this.radius, d2, f5);
            this.smoothForVertical = SmoothPathProvider.smoothForHeight(fHeight, this.radius, d2, f5);
            ...
            double d3 = f5;
            double dKForWidth = SmoothPathProvider.kForWidth(this.smoothForHorizontal * d3, this.thetaForHorizontal);
            ...
            double dKForHeight = SmoothPathProvider.kForHeight(this.smoothForVertical * d3, this.thetaForVertical);
    ...
    public void buildSmoothData(RectF rectF, float f2) {
        buildSmoothData(rectF, f2, 0.0f, 0.0f);
    }

    public void drawPath(Canvas canvas, Paint paint, int i2, int i3, int i4) {
    ...
    public void buildSmoothData(RectF rectF, float f2, float f3, float f4) {
        buildSmoothData(rectF, new float[]{f2, f2, f2, f2, f2, f2, f2, f2}, f3, f4);
    }
    ...
    public void buildSmoothData(RectF rectF, float[] fArr, float f2, float f3) {
        float f4;
        float f5;
        float f6;
        float f7;
        ...
        float fHeight = rectF.height();
        double d2 = smooth;
        this.mAllData = new SmoothData(fWidth, fHeight, d2, ksi);
        if (fArr == null) {
            return;
        }
        ...
        this.mAllData.topLeft.build(Math.min(f8, f9), rectF, f2, f3, d2, ksi, 0);
        this.mAllData.topRight.build(Math.min(f17, f4), rectF, f2, f3, d2, ksi, 1);
        this.mAllData.bottomRight.build(Math.min(f6, f13), rectF, f2, f3, d2, ksi, 2);
        this.mAllData.bottomLeft.build(Math.min(f5, f7), rectF, f2, f3, d2, ksi, 3);
    }
}

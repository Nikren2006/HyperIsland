...
public class ViewDragHelper {
    ...
    private final Runnable mSetIdleRunnable = new Runnable() { // from class: miuix.internal.util.ViewDragHelper.2
    ...
    private boolean checkTouchSlop(View view, float f2, float f3) {
        ...
        if (!z2 || !z3) {
            return z2 ? Math.abs(f3) < ((float) this.mTouchSlop) && Math.abs(f2) > ((float) this.mTouchSlop) : z3 && Math.abs(f2) < ((float) this.mTouchSlop) && Math.abs(f3) > ((float) this.mTouchSlop);
        }
    ...
    /* JADX WARN: Type inference failed for: r2v1, types: [miuix.internal.util.ViewDragHelper$Callback] */
    ...
    public void processTouchEvent(MotionEvent motionEvent) {
        ...
        if (actionMasked == 2) {
            if (this.mDragState == 1) {
                if (isValidPointerForActionMove(this.mActivePointerId) && (iFindPointerIndex = motionEvent.findPointerIndex(this.mActivePointerId)) >= 0 && iFindPointerIndex < motionEvent.getPointerCount()) {
    ...
    */
    public boolean shouldInterceptTouchEvent(android.view.MotionEvent r11) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: miuix.internal.util.ViewDragHelper.shouldInterceptTouchEvent(android.view.MotionEvent):boolean");
    }

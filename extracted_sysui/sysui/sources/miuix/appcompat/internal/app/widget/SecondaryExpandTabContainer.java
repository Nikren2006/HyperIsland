...
public class SecondaryExpandTabContainer extends SpringBackLayout implements SecondaryTabBar {

    @NonNull
    private final SecondaryTabExpandContainerView mTabContainer;

    public SecondaryExpandTabContainer(Context context) {
        super(context);
        setScrollOrientation(1);
        SecondaryTabExpandContainerView secondaryTabExpandContainerView = new SecondaryTabExpandContainerView(context);
        this.mTabContainer = secondaryTabExpandContainerView;
        addView(secondaryTabExpandContainerView);
        secondaryTabExpandContainerView.setContentHeight(secondaryTabExpandContainerView.getTabContainerHeight());
        setTarget(secondaryTabExpandContainerView);
    }

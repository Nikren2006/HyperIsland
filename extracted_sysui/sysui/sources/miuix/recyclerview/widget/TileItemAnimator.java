...
public class TileItemAnimator extends SimpleScaleItemAnimator {
    ...
    private static final String ERROR_MSG_CANCEL = "after animation is cancelled, item should not be in ";
    private static final long REMOVE_DELAY = 100;
    private static final TimeInterpolator sDefaultInterpolator = new ValueAnimator().getInterpolator();
    ...
    public void animateAddImpl(final RecyclerView.ViewHolder viewHolder) {
        ...
        viewPropertyAnimatorAnimate.alpha(1.0f).setDuration(getAddDuration()).setListener(new AnimatorListenerAdapter() { // from class: miuix.recyclerview.widget.TileItemAnimator.2
            ...
            public void onAnimationEnd(Animator animator) {
                ...
                TileItemAnimator.this.dispatchAddFinished(viewHolder);
                TileItemAnimator.this.mAddAnimations.remove(viewHolder);
                TileItemAnimator.this.dispatchFinishedWhenDone();
            }

            @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
            public void onAnimationStart(Animator animator) {
                TileItemAnimator.this.dispatchAddStarting(viewHolder);
            }
        }).start();
    }
        ...
        if (view != null) {
            ...
            duration.alpha(0.0f).setListener(new AnimatorListenerAdapter() { // from class: miuix.recyclerview.widget.TileItemAnimator.4
                ...
                public void onAnimationEnd(Animator animator) {
                    ...
                    TileItemAnimator.this.dispatchChangeFinished(changeInfo.oldHolder, true);
                    TileItemAnimator.this.mChangeAnimations.remove(changeInfo.oldHolder);
                    TileItemAnimator.this.dispatchFinishedWhenDone();
                }

                @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                public void onAnimationStart(Animator animator) {
                    TileItemAnimator.this.dispatchChangeStarting(changeInfo.oldHolder, true);
                }
            }).start();
        }
        if (view2 != null) {
            ...
            viewPropertyAnimatorAnimate.setInterpolator(INTERPOLATOR);
            viewPropertyAnimatorAnimate.translationX(0.0f).translationY(0.0f).setDuration(getChangeDuration()).alpha(1.0f).setListener(new AnimatorListenerAdapter() { // from class: miuix.recyclerview.widget.TileItemAnimator.5
                @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                public void onAnimationEnd(Animator animator) {
                    viewPropertyAnimatorAnimate.setListener(null);
                    view2.setAlpha(1.0f);
                    ...
                    TileItemAnimator.this.dispatchChangeFinished(changeInfo.newHolder, false);
                    TileItemAnimator.this.mChangeAnimations.remove(changeInfo.newHolder);
                    TileItemAnimator.this.dispatchFinishedWhenDone();
                }

                @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                public void onAnimationStart(Animator animator) {
                    TileItemAnimator.this.dispatchChangeStarting(changeInfo.newHolder, false);
                }
            }).start();
        }
    }
    ...
    public boolean animateMove(RecyclerView.ViewHolder viewHolder, int i2, int i3, int i4, int i5, int i6, int i7, int i8, int i9) {
    ...
    public void animateMoveImpl(final RecyclerView.ViewHolder viewHolder, int i2, int i3, int i4, int i5) {
        ...
        viewPropertyAnimatorAnimate.setInterpolator(INTERPOLATOR);
        viewPropertyAnimatorAnimate.scaleX(1.0f).scaleY(1.0f).setDuration(getMoveDuration()).setListener(new AnimatorListenerAdapter() { // from class: miuix.recyclerview.widget.TileItemAnimator.3
            @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
            public void onAnimationCancel(Animator animator) {
                view.setTranslationX(0.0f);
                view.setTranslationY(0.0f);
            ...
            public void onAnimationEnd(Animator animator) {
                viewPropertyAnimatorAnimate.setListener(null);
                TileItemAnimator.this.dispatchMoveFinished(viewHolder);
                TileItemAnimator.this.mMoveAnimations.remove(viewHolder);
                TileItemAnimator.this.dispatchFinishedWhenDone();
            }

            @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
            public void onAnimationStart(Animator animator) {
                TileItemAnimator.this.dispatchMoveStarting(viewHolder);
            }
        }).start();
    }
    ...
    public void animateRemoveImpl(final RecyclerView.ViewHolder viewHolder) {
        ...
        viewPropertyAnimatorAnimate.setInterpolator(INTERPOLATOR);
        viewPropertyAnimatorAnimate.setDuration(getRemoveDuration()).alpha(0.0f).setListener(new AnimatorListenerAdapter() { // from class: miuix.recyclerview.widget.TileItemAnimator.1
            @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
            public void onAnimationEnd(Animator animator) {
                viewPropertyAnimatorAnimate.setListener(null);
                view.setAlpha(1.0f);
                TileItemAnimator.this.dispatchRemoveFinished(viewHolder);
                TileItemAnimator.this.mRemoveAnimations.remove(viewHolder);
                TileItemAnimator.this.dispatchFinishedWhenDone();
            }

            @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
            public void onAnimationStart(Animator animator) {
                TileItemAnimator.this.dispatchRemoveStarting(viewHolder);
            }
        }).start();
    }
    ...
    public void runPendingAnimations() {
        ...
        if (!zIsEmpty2) {
            ...
            Runnable runnable = new Runnable() { // from class: miuix.recyclerview.widget.b
                ...
                public final void run() {
                    this.f6155a.lambda$runPendingAnimations$0(arrayList);
                }
            };
            if (zIsEmpty) {
                runnable.run();
        ...
        if (!zIsEmpty3) {
            ...
            Runnable runnable2 = new Runnable() { // from class: miuix.recyclerview.widget.c
                @Override // java.lang.Runnable
                public final void run() {
                    this.f6157a.lambda$runPendingAnimations$1(arrayList2);
                }
            };
            if (zIsEmpty) {
                runnable2.run();
        ...
        Runnable runnable3 = new Runnable() { // from class: miuix.recyclerview.widget.d
            @Override // java.lang.Runnable
            public final void run() {
                this.f6159a.lambda$runPendingAnimations$2(arrayList3);
            }
        };

...
public class NestedScrollView extends FrameLayout implements NestedScrollingParent3, NestedScrollingChild3, ScrollingView, NestedContentInsetObserver {
    ...
    */
    private android.view.View findFocusableViewInBounds(boolean r12, int r13, int r14) {
        ...
        L53:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: miuix.core.widget.NestedScrollView.findFocusableViewInBounds(boolean, int, int):android.view.View");
    }
    ...
    public void computeScroll() {
        ...
        if (HapticCompat.doesSupportHaptic(HapticCompat.HapticVersion.HAPTIC_VERSION_2)) {
            getHapticFeedbackCompat().lambda$performExtHapticFeedbackAsync$0(EaseManager.EaseStyleDef.PERLIN);
        } else {
    ...
    public void onContentInsetChanged(Rect rect) {
        ...
        setPadding(getPaddingLeft(), Math.max(rect.top, this.mInitPaddingTop), getPaddingRight(), getPaddingBottom());
    }
    ...
    */
    ...
    private void smoothScrollBy(int i2, int i3, boolean z2) {
        ...
        if (AnimationUtils.currentAnimationTimeMillis() - this.mLastScroll > 250) {
            ...
            int scrollY = getScrollY();
            this.mScroller.startScroll(getScrollX(), scrollY, 0, Math.max(0, Math.min(i3 + scrollY, Math.max(0, height - height2))) - scrollY);

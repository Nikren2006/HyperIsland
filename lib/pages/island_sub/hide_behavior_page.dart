                ...
                Card(
                  ...
                  child: Column(
                    children: [
                      ...
                      const Divider(height: 1, indent: 16, endIndent: 16),
                      _SwitchTile(
                        title: l10n.hideBehaviorDesktopAnimating,
                        subtitle: l10n.hideBehaviorDesktopAnimatingSubtitle,
                        value: _ctrl.tempHideDesktopAnimating,
                        onChanged: _ctrl.setTempHideDesktopAnimating,
                        titleStyle: titleStyle,
                      ),
                      const Divider(height: 1, indent: 16, endIndent: 16),
                      _SwitchTile(
                      ...
                      const Divider(height: 1, indent: 16, endIndent: 16),
                      _SwitchTile(
                        title: l10n.hideBehaviorControlCenter,
                        subtitle: l10n.hideBehaviorControlCenterSubtitle,
                        value: _ctrl.tempHideControlCenter,
                        onChanged: _ctrl.setTempHideControlCenter,
                        titleStyle: titleStyle,
                      ),
                    ],
                  ),
